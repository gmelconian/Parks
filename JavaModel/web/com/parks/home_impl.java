...
public final  class home_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2021102014432331", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("com.parks.home", new String[] {}, new String[] {}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.parks.GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_5", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_5, (byte)(8), (byte)(0), ",", "")));
   }
   ...
   {
      return formatLink("com.parks.home", new String[] {}, new String[] {})  ;
   }
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 4), "LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           AV5MenuItem = httpContext.cgiGet( edtavMenuitem_Internalname) ;
                           httpContext.ajax_rsp_assign_attri("", false, edtavMenuitem_Internalname, AV5MenuItem);
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
   ...
   public void rf0E2( )
   {
      ...
      Grid1Container.AddObjectProperty("Class", GXutil.rtrim( ""));
   ...
   public void strup0E0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         nRC_GXsfl_5 = (int)(localUtil.ctol( httpContext.cgiGet( "nRC_GXsfl_5"), ",", ".")) ;
   ...
   private void e110E2( )
   {
      /* Load Routine */
      returnInSub = false ;
      GXv_objcol_SdtProgramNames_ProgramName1[0] = AV6ProgramNames ;
      new com.parks.listprograms(remoteHandle, context).execute( GXv_objcol_SdtProgramNames_ProgramName1) ;
      AV6ProgramNames = GXv_objcol_SdtProgramNames_ProgramName1[0] ;
      AV10GXV1 = 1 ;
      while ( AV10GXV1 <= AV6ProgramNames.size() )
      {
         AV7ProgramName = (com.parks.SdtProgramNames_ProgramName)((com.parks.SdtProgramNames_ProgramName)AV6ProgramNames.elementAt(-1+AV10GXV1));
         AV5MenuItem = AV7ProgramName.getgxTv_SdtProgramNames_ProgramName_Description() ;
         httpContext.ajax_rsp_assign_attri("", false, edtavMenuitem_Internalname, AV5MenuItem);
         edtavMenuitem_Link = AV7ProgramName.getgxTv_SdtProgramNames_ProgramName_Link() ;
         sendrow_52( ) ;
         if ( isFullAjaxMode( ) && ! bGXsfl_5_Refreshing )
         {
            httpContext.doAjaxLoad(5, Grid1Row);
         }
   ...
   public void wb_table1_2_0E2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         sStyleString += " height: " + GXutil.ltrimstr( DecimalUtil.doubleToDec(100), 10, 0) + "%" + ";" ;
         ...
         if ( Grid1Container.GetWrapped() == 1 )
         {
            httpContext.writeText( "<div id=\""+"Grid1Container"+"DivS\" data-gxgridid=\"5\">") ;
            sStyleString = "" ;
            sStyleString += " width: " + GXutil.ltrimstr( DecimalUtil.doubleToDec(100), 10, 0) + "%" + ";" ;
            com.parks.GxWebStd.gx_table_start( httpContext, subGrid1_Internalname, subGrid1_Internalname, "", "", 0, "", "", 1, 0, sStyleString, "", "", 0);
            Grid1Container.AddObjectProperty("GridName", "Grid1");
         }
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            Grid1Column.AddObjectProperty("Value", GXutil.rtrim( AV5MenuItem));
            Grid1Column.AddObjectProperty("Link", GXutil.rtrim( edtavMenuitem_Link));
            Grid1Container.AddColumnProperties(Grid1Column);
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2021102014432343", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("home.js", "?2021102014432343", false, true);
      }
   ...
   public void sendrow_52( )
   {
      ...
      if ( Grid1Container.GetWrapped() == 1 )
      {
         httpContext.writeText( "<tr"+" class=\""+subGrid1_Linesclass+"\" style=\""+""+"\""+" data-gxrow=\""+sGXsfl_5_idx+"\">") ;
      }
      Grid1Row.AddColumnProperties("row", -1, isAjaxCallMode( ), new Object[] {"",subGrid1_Linesclass,""});
      Grid1Row.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {"","",""});
      /* Single line edit */
      ROClassString = "Attribute" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavMenuitem_Internalname,GXutil.rtrim( AV5MenuItem),"","","'"+""+"'"+",false,"+"'"+""+"'",edtavMenuitem_Link,"","","",edtavMenuitem_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"","",Integer.valueOf(1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(80),"chr",Integer.valueOf(1),"row",Integer.valueOf(100),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(5),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(false),"","left",Boolean.valueOf(true),""});
      if ( Grid1Container.GetWrapped() == 1 )
      {
   ...
   public void initialize( )
   {
      ...
      sEvtType = "" ;
      AV5MenuItem = "" ;
      AV6ProgramNames = new GXBaseCollection<com.parks.SdtProgramNames_ProgramName>(com.parks.SdtProgramNames_ProgramName.class, "ProgramName", "Parks", remoteHandle);
      GXv_objcol_SdtProgramNames_ProgramName1 = new GXBaseCollection[1] ;
      AV7ProgramName = new com.parks.SdtProgramNames_ProgramName(remoteHandle, context);
   ...
   private GXBaseCollection<com.parks.SdtProgramNames_ProgramName> AV6ProgramNames ;
   private GXBaseCollection<com.parks.SdtProgramNames_ProgramName> GXv_objcol_SdtProgramNames_ProgramName1[] ;
   private com.parks.SdtProgramNames_ProgramName AV7ProgramName ;
}
