...
public final  class countrygeneral_impl extends GXWebComponent
{
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(A12CountryId)});
               componentstart();
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?202110201443168", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.parks.countrygeneral", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A12CountryId,4,0))}, new String[] {"CountryId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOA12CountryId", GXutil.ltrim( localUtil.ntoc( wcpOA12CountryId, (byte)(4), (byte)(0), ",", "")));
   }
   ...
   public void wb0S0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.parks.countrygeneral");
         }
         ...
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", "Modificar", bttBtnupdate_Jsonclick, 7, "Modificar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110s1_client"+"'", TempTags, "", 2, "HLP_CountryGeneral.htm");
         ...
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e120s1_client"+"'", TempTags, "", 2, "HLP_CountryGeneral.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.parks.GxWebStd.gx_label_element( httpContext, edtCountryId_Internalname, "Id", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
         /* Div Control */
         ...
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         com.parks.GxWebStd.gx_single_line_edit( httpContext, edtCountryName_Internalname, GXutil.rtrim( A13CountryName), GXutil.rtrim( localUtil.format( A13CountryName, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCountryName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtCountryName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Name", "left", true, "", "HLP_CountryGeneral.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void rf0S2( )
   {
      ...
      {
         /* Using cursor H000S2 */
         pr_default.execute(0, new Object[] {Short.valueOf(A12CountryId)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A13CountryName = H000S2_A13CountryName[0] ;
   ...
   public void strup0S0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         wcpOA12CountryId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA12CountryId"), ",", ".")) ;
   ...
   {
      A12CountryId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "A12CountryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A12CountryId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlA12CountryId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      {
         A12CountryId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A12CountryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A12CountryId), 4, 0));
      }
      wcpOA12CountryId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA12CountryId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( A12CountryId != wcpOA12CountryId ) ) )
      {
         setjustcreated();
      }
      wcpOA12CountryId = A12CountryId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlA12CountryId = httpContext.cgiGet( sPrefix+"A12CountryId_CTRL") ;
      if ( GXutil.len( sCtrlA12CountryId) > 0 )
      {
         A12CountryId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlA12CountryId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A12CountryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A12CountryId), 4, 0));
      }
      else
      {
         A12CountryId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"A12CountryId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"A12CountryId_PARM", GXutil.ltrim( localUtil.ntoc( A12CountryId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlA12CountryId)) > 0 )
      {
         com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"A12CountryId_CTRL", GXutil.rtrim( sCtrlA12CountryId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2021102014431624", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("countrygeneral.js", "?2021102014431625", false, true);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'A12CountryId',fld:'COUNTRYID',pic:'ZZZ9'}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("'DOUPDATE'","{handler:'e110S1',iparms:[{av:'A12CountryId',fld:'COUNTRYID',pic:'ZZZ9'}]");
      setEventMetadata("'DOUPDATE'",",oparms:[]}");
      setEventMetadata("'DODELETE'","{handler:'e120S1',iparms:[{av:'A12CountryId',fld:'COUNTRYID',pic:'ZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      sCtrlA12CountryId = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.parks.countrygeneral__default(),
         new Object[] {
             new Object[] {
   ...
   private short wcpOA12CountryId ;
   ...
   private String sCtrlA12CountryId ;
...
final  class countrygeneral__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H000S2", "SELECT `CountryId`, `CountryName` FROM `Country` WHERE `CountryId` = ? ORDER BY `CountryId` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
