...
public final  class GxWebStd
{
                                           ...
                                           String sCallerPgm )
   {
      ...
      if ( ( httpContext.getWrapped( ) && ( ( nRTEnabled != 0 ) || ( nEnabled != 0 ) ) ) || ! httpContext.getWrapped( ) )
      {
         ...
         {
            com.parks.GxWebStd.styleAttribute( httpContext, sStyleString+"text-align:"+sAlign);
         }
         else
         {
      ...
      if ( nEnabled == 0 )
      {
         ...
         if ( nFormat != 2 )
         {
            ...
            com.parks.GxWebStd.classAttribute( httpContext, ClassHTML);
                                     ...
                                     String sCallerPgm )
   {
      ...
      else
      {
         if ( nDisplay == 1 )
         {
            ...
            if ( GXutil.strcmp(sURL, "") != 0 )
            {
               com.parks.GxWebStd.styleAttribute( httpContext, "display:block;"+sStyleString);
            }
            else
            {
               com.parks.GxWebStd.styleAttribute( httpContext, "display:none;"+sStyleString);
            }
                                         ...
                                         String sCallerPgm )
   {
      ...
      com.parks.GxWebStd.classAttribute( httpContext, sClassString);
      com.parks.GxWebStd.styleAttribute( httpContext, sStyleString);
      com.parks.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "data-jsevent", sUserOnClickCode, false, false);
      com.parks.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "data-gxoch0", sEventJsCode, true, false);
      httpContext.writeText( sTags) ;
                                          ...
                                          String sImgSrcSet )
   {
      ...
      {
         com.parks.GxWebStd.gx_start_js_anchor( httpContext, nJScriptCode, sEventJsCode, sUserOnClickCode, sLinkURL, sLinkTarget, "gx-image-link");
      }
      if ( ! (GXutil.strcmp("", sImageURL)==0) )
      {
                                                ...
                                                String sCallerPgm )
   {
      ...
      com.parks.GxWebStd.gx_single_line_edit( httpContext, sInternalName+"_GXI", sURL, sURL, sInputTags, sEventName, "", "", sTooltipText, "", sUserOnClickCode, 0, "field "+sClassString, sStyleString, "", "", "", 1, 1, 1, "text", "", nWidth, nWidthUnit, nHeight, nHeightUnit, 254, (byte)(0), (short)(2), 0, (byte)(1), (byte)(1), (byte)(0), true, "", sAlign, false, "", sCallerPgm);
                                ...
                                String sCallerPgm )
   {
      ...
      if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
      {
         com.parks.GxWebStd.gx_multimedia_upload_end( httpContext, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", "", sInputTags, nReadOnly, bIsBlob, "video/*", sCallerPgm);
      }
   }
                                ...
                                String sCallerPgm )
   {
      ...
      if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
      {
         com.parks.GxWebStd.gx_multimedia_upload_end( httpContext, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", "", sInputTags, nReadOnly, bIsBlob, "audio/*", sCallerPgm);
      }
   }
                               ...
                               String sCallerPgm )
   {
      ...
      if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
      {
         com.parks.GxWebStd.gx_multimedia_upload_end( httpContext, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", "", sInputTags, nReadOnly, bIsBlob, "*", sCallerPgm);
      }
   }
                                        ...
                                        String sCallerPgm )
   {
      ...
      com.parks.GxWebStd.classAttribute( httpContext, sClassString);
      com.parks.GxWebStd.styleAttribute( httpContext, sTextAreaStyleString);
      ...
      com.parks.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "maxlength", sLength, false, true);
      httpContext.writeTextNL( ">") ;
      httpContext.writeValue( sValue) ;
      ...
      if ( nEnabled == 0 )
      {
         ...
         com.parks.GxWebStd.gx_start_js_anchor( httpContext, nJScriptCode, sEventJsCode, "", sLinkURL, sLinkTarget, "");
         if ( nFormat == 0 )
         {
         ...
         com.parks.GxWebStd.gx_end_js_anchor( httpContext, sEventJsCode, "", sLinkURL);
         httpContext.writeText( "</span>") ;
      }
   }
                                      ...
                                      String rtPicture )
   {
      ...
      com.parks.GxWebStd.gx_single_line_edit( httpContext, sCtrlName, sValue, sFormatedValue, sTagsLocal, sEventName, sLinkURL, sLinkTarget, sTooltipText, sPlaceholder, sUserOnClickCode, nJScriptCode, sClassString, sStyleString, sROClassString, sColumnClassString, sColumnHeaderClassString, nVisible, nEnabled, nRTEnabled, sType, sStep, nWidth, nWidthUnit, nHeight, nHeightUnit, nLength, nIsPassword, nFormat, nParentId, bHasTheme, nAutoComplete, nAutoCorrection, bSendHidden, sDomainType, "", false, "", "");
      if ( ( nRTEnabled != 0 ) || ( nEnabled != 0 ) )
      {
         com.parks.GxWebStd.gx_bitmap_readonly( httpContext, sCtrlName+"_geoLocMe", httpContext.convertURL( "locateMe"), "", "", "", "", nVisible, 1, httpContext.getMessage( "GXM_locatemeoption", ""), httpContext.getMessage( "GXM_locatemeoption", ""), 0, 0, 0, nWidthUnit, 0, nHeightUnit, 0, 0, 4, sUserOnClickCode, sEventName, sStyleString, "GeoLocOption", "", "", "", "", "", "gx.geolocation.getMyPosition(this);", "", "");
      }
   }
                                      ...
                                      String sCallerPgm )
   {
      ...
      com.parks.GxWebStd.classAttribute( httpContext, sClassString+"Title");
      httpContext.writeText( ">") ;
      httpContext.writeText( sCaption) ;
      httpContext.writeText( "</legend>") ;
   }
