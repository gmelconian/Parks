...
public final  class wwshow_impl extends GXDataArea
{
   public wwshow_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwshow_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwshow_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            AV11ShowName = httpContext.GetPar( "ShowName") ;
            AV12Update = httpContext.GetPar( "Update") ;
            AV13Delete = httpContext.GetPar( "Delete") ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            ...
            gxgrgrid_refresh( subGrid_Rows, AV11ShowName, AV12Update, AV13Delete) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.parks.wwshow", new String[] {}, new String[] {}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.parks.GxWebStd.gx_hidden_field( httpContext, "GXH_vSHOWNAME", GXutil.rtrim( AV11ShowName));
      /* Send saved values. */
   ...
   {
      return formatLink("com.parks.wwshow", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb110( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.parks.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Shows", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, (short)(0), "HLP_WWShow.htm");
         ...
         ClassString = "BtnAdd" ;
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 25, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWShow.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.parks.GxWebStd.gx_label_element( httpContext, edtavShowname_Internalname, "Show Name", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"" ;
         com.parks.GxWebStd.gx_single_line_edit( httpContext, edtavShowname_Internalname, GXutil.rtrim( AV11ShowName), GXutil.rtrim( localUtil.format( AV11ShowName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavShowname_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavShowname_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_WWShow.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A14ShowId, (byte)(4), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.rtrim( A15ShowName));
            GridColumn.AddObjectProperty("Link", GXutil.rtrim( edtShowName_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", httpContext.convertURL( A16ShowImage));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.format(A50ShowDate, "99/99/99"));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.ttoc( A51ShowSchedule, 10, 8, 0, 3, "/", ":", " "));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
   ...
   public void start112( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Shows", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtShowImage_Internalname, "Bitmap", ((GXutil.strcmp("", A16ShowImage)==0) ? A40000ShowImage_GXI : httpContext.convertURL( httpContext.getResourceRelative(A16ShowImage))), !bGXsfl_25_Refreshing);
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false ;
                                    /* Set Refresh If Showname Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vSHOWNAME"), AV11ShowName) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void pa112( )
   {
      if ( nDonePA == 0 )
      {
         ...
         if ( ! httpContext.isAjaxRequest( ) )
         {
            GX_FocusControl = edtavShowname_Internalname ;
   ...
   public void rf112( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV11ShowName = GXutil.padr( GXutil.rtrim( AV11ShowName), 50, "%") ;
         /* Using cursor H00112 */
         pr_default.execute(0, new Object[] {lV11ShowName, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_25_idx = 1 ;
         sGXsfl_25_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_25_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_252( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A51ShowSchedule = H00112_A51ShowSchedule[0] ;
            A50ShowDate = H00112_A50ShowDate[0] ;
            A16ShowImage = H00112_A16ShowImage[0] ;
            httpContext.ajax_rsp_assign_prop("", false, edtShowImage_Internalname, "Bitmap", ((GXutil.strcmp("", A16ShowImage)==0) ? A40000ShowImage_GXI : httpContext.convertURL( httpContext.getResourceRelative(A16ShowImage))), !bGXsfl_25_Refreshing);
            httpContext.ajax_rsp_assign_prop("", false, edtShowImage_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A16ShowImage), true);
            A40000ShowImage_GXI = H00112_A40000ShowImage_GXI[0] ;
            httpContext.ajax_rsp_assign_prop("", false, edtShowImage_Internalname, "Bitmap", ((GXutil.strcmp("", A16ShowImage)==0) ? A40000ShowImage_GXI : httpContext.convertURL( httpContext.getResourceRelative(A16ShowImage))), !bGXsfl_25_Refreshing);
            httpContext.ajax_rsp_assign_prop("", false, edtShowImage_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A16ShowImage), true);
            A15ShowName = H00112_A15ShowName[0] ;
            A14ShowId = H00112_A14ShowId[0] ;
            e14112 ();
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, "gxhash_SHOWID"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, localUtil.format( DecimalUtil.doubleToDec(A14ShowId), "ZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV11ShowName = GXutil.padr( GXutil.rtrim( AV11ShowName), 50, "%") ;
      /* Using cursor H00113 */
      pr_default.execute(1, new Object[] {lV11ShowName});
   ...
   public void subgrid_varsfromstate( )
   {
      ...
      {
         AV11ShowName = GridState.filterValues("Showname") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV11ShowName", AV11ShowName);
      }
   ...
   public void subgrid_varstostate( )
   {
      ...
      GridState.addFilterValue("ShowName", AV11ShowName);
   }
   ...
   public void strup110( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11ShowName = httpContext.cgiGet( edtavShowname_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV11ShowName", AV11ShowName);
   ...
   private void e14112( )
   {
      /* Grid_Load Routine */
      returnInSub = false ;
      edtavUpdate_Link = formatLink("com.parks.show", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A14ShowId,4,0))}, new String[] {"Mode","ShowId"})  ;
      edtavDelete_Link = formatLink("com.parks.show", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A14ShowId,4,0))}, new String[] {"Mode","ShowId"})  ;
      edtShowName_Link = formatLink("com.parks.viewshow", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A14ShowId,4,0)),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"ShowId","TabCode"})  ;
      /* Load Method */
      if ( wbStart != -1 )
      {
         wbStart = (short)(25) ;
   ...
   public void e11112( )
   {
      /* 'DoInsert' Routine */
      returnInSub = false ;
      callWebObject(formatLink("com.parks.show", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","ShowId"}) );
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S112( )
   {
      ...
      AV9TrnContext.setgxTv_SdtTransactionContext_Transactionname( "Show" );
   ...
   {
      edtShowId_Internalname = "SHOWID_"+sGXsfl_25_idx ;
      edtShowName_Internalname = "SHOWNAME_"+sGXsfl_25_idx ;
      edtShowImage_Internalname = "SHOWIMAGE_"+sGXsfl_25_idx ;
      edtShowDate_Internalname = "SHOWDATE_"+sGXsfl_25_idx ;
      edtShowSchedule_Internalname = "SHOWSCHEDULE_"+sGXsfl_25_idx ;
   ...
   {
      edtShowId_Internalname = "SHOWID_"+sGXsfl_25_fel_idx ;
      edtShowName_Internalname = "SHOWNAME_"+sGXsfl_25_fel_idx ;
      edtShowImage_Internalname = "SHOWIMAGE_"+sGXsfl_25_fel_idx ;
      edtShowDate_Internalname = "SHOWDATE_"+sGXsfl_25_fel_idx ;
      edtShowSchedule_Internalname = "SHOWSCHEDULE_"+sGXsfl_25_fel_idx ;
   ...
   public void sendrow_252( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtShowId_Internalname,GXutil.ltrim( localUtil.ntoc( A14ShowId, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A14ShowId), "ZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtShowId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn","",Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(0),"number","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(25),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtShowSchedule_Internalname,localUtil.ttoc( A51ShowSchedule, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A51ShowSchedule, "99/99/99 99:99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtShowSchedule_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(14),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(25),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
   ...
   public void init_default_properties( )
   {
      ...
      edtavShowname_Internalname = "vSHOWNAME" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtavShowname_Jsonclick = "" ;
      edtavShowname_Enabled = 1 ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11ShowName',fld:'vSHOWNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e14112',iparms:[{av:'A14ShowId',fld:'SHOWID',pic:'ZZZ9',hsh:true}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtShowName_Link',ctrl:'SHOWNAME',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e11112',iparms:[{av:'A14ShowId',fld:'SHOWID',pic:'ZZZ9',hsh:true}]");
      setEventMetadata("'DOINSERT'",",oparms:[]}");
      setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11ShowName',fld:'vSHOWNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
      setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11ShowName',fld:'vSHOWNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
      setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11ShowName',fld:'vSHOWNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
      setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11ShowName',fld:'vSHOWNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV11ShowName = "" ;
      H00112_A51ShowSchedule = new java.util.Date[] {GXutil.nullDate()} ;
      H00112_A50ShowDate = new java.util.Date[] {GXutil.nullDate()} ;
      H00112_A16ShowImage = new String[] {""} ;
      H00112_A40000ShowImage_GXI = new String[] {""} ;
      H00112_A15ShowName = new String[] {""} ;
      H00112_A14ShowId = new short[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.parks.wwshow__default(),
         new Object[] {
             new Object[] {
            H00112_A51ShowSchedule, H00112_A50ShowDate, H00112_A16ShowImage, H00112_A40000ShowImage_GXI, H00112_A15ShowName, H00112_A14ShowId
            }
            , new Object[] {
   ...
   private int edtavShowname_Enabled ;
   ...
   private String edtavShowname_Internalname ;
   private String edtavShowname_Jsonclick ;
   ...
   private java.util.Date[] H00112_A51ShowSchedule ;
   private java.util.Date[] H00112_A50ShowDate ;
   private String[] H00112_A16ShowImage ;
   private String[] H00112_A40000ShowImage_GXI ;
   private String[] H00112_A15ShowName ;
   private short[] H00112_A14ShowId ;
...
final  class wwshow__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          String A15ShowName )
   {
      ...
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV11ShowName)==0) )
      {
      ...
      sOrderString += " ORDER BY `ShowName`" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00112(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
            case 1 :
                  return conditional_H00113(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
      }
