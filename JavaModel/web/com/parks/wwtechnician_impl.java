...
public final  class wwtechnician_impl extends GXDataArea
{
   public wwtechnician_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwtechnician_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwtechnician_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            AV11TechnicianName = httpContext.GetPar( "TechnicianName") ;
            AV12Update = httpContext.GetPar( "Update") ;
            AV13Delete = httpContext.GetPar( "Delete") ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            ...
            gxgrgrid_refresh( subGrid_Rows, AV11TechnicianName, AV12Update, AV13Delete) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.parks.wwtechnician", new String[] {}, new String[] {}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.parks.GxWebStd.gx_hidden_field( httpContext, "GXH_vTECHNICIANNAME", GXutil.rtrim( AV11TechnicianName));
      /* Send saved values. */
   ...
   {
      return formatLink("com.parks.wwtechnician", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb1A0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.parks.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Technicians", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, (short)(0), "HLP_WWTechnician.htm");
         ...
         ClassString = "BtnAdd" ;
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 25, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWTechnician.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.parks.GxWebStd.gx_label_element( httpContext, edtavTechnicianname_Internalname, "Technician Name", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"" ;
         com.parks.GxWebStd.gx_single_line_edit( httpContext, edtavTechnicianname_Internalname, GXutil.rtrim( AV11TechnicianName), GXutil.rtrim( localUtil.format( AV11TechnicianName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavTechnicianname_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavTechnicianname_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_WWTechnician.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.rtrim( A33TechnicianPhone));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
   ...
   public void start1A2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Technicians", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false ;
                                    /* Set Refresh If Technicianname Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vTECHNICIANNAME"), AV11TechnicianName) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void pa1A2( )
   {
      if ( nDonePA == 0 )
      {
         ...
         if ( ! httpContext.isAjaxRequest( ) )
         {
            GX_FocusControl = edtavTechnicianname_Internalname ;
   ...
   public void rf1A2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV11TechnicianName = GXutil.padr( GXutil.rtrim( AV11TechnicianName), 50, "%") ;
         /* Using cursor H001A2 */
         pr_default.execute(0, new Object[] {lV11TechnicianName, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_25_idx = 1 ;
         sGXsfl_25_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_25_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_252( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A24CityId = H001A2_A24CityId[0] ;
            A12CountryId = H001A2_A12CountryId[0] ;
            A25CityName = H001A2_A25CityName[0] ;
            A13CountryName = H001A2_A13CountryName[0] ;
            A33TechnicianPhone = H001A2_A33TechnicianPhone[0] ;
            A32TechnicianLastName = H001A2_A32TechnicianLastName[0] ;
            A31TechnicianName = H001A2_A31TechnicianName[0] ;
            A30TechnicianId = H001A2_A30TechnicianId[0] ;
            A13CountryName = H001A2_A13CountryName[0] ;
            A25CityName = H001A2_A25CityName[0] ;
            e141A2 ();
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, "gxhash_TECHNICIANID"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, localUtil.format( DecimalUtil.doubleToDec(A30TechnicianId), "ZZZ9")));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV11TechnicianName = GXutil.padr( GXutil.rtrim( AV11TechnicianName), 50, "%") ;
      /* Using cursor H001A3 */
      pr_default.execute(1, new Object[] {lV11TechnicianName});
   ...
   public void subgrid_varsfromstate( )
   {
      ...
      {
         AV11TechnicianName = GridState.filterValues("Technicianname") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV11TechnicianName", AV11TechnicianName);
      }
   ...
   public void subgrid_varstostate( )
   {
      ...
      GridState.addFilterValue("TechnicianName", AV11TechnicianName);
   }
   ...
   public void strup1A0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11TechnicianName = httpContext.cgiGet( edtavTechnicianname_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV11TechnicianName", AV11TechnicianName);
   ...
   private void e141A2( )
   {
      /* Grid_Load Routine */
      returnInSub = false ;
      edtavUpdate_Link = formatLink("com.parks.technician", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A30TechnicianId,4,0))}, new String[] {"Mode","TechnicianId"})  ;
      edtavDelete_Link = formatLink("com.parks.technician", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A30TechnicianId,4,0))}, new String[] {"Mode","TechnicianId"})  ;
   ...
   public void e111A2( )
   {
      /* 'DoInsert' Routine */
      returnInSub = false ;
      callWebObject(formatLink("com.parks.technician", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","TechnicianId"}) );
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S112( )
   {
      ...
      AV9TrnContext.setgxTv_SdtTransactionContext_Transactionname( "Technician" );
   ...
   public void subsflControlProps_252( )
   {
      ...
      edtTechnicianPhone_Internalname = "TECHNICIANPHONE_"+sGXsfl_25_idx ;
   ...
   public void subsflControlProps_fel_252( )
   {
      ...
      edtTechnicianPhone_Internalname = "TECHNICIANPHONE_"+sGXsfl_25_fel_idx ;
   ...
   public void init_default_properties( )
   {
      ...
      edtavTechnicianname_Internalname = "vTECHNICIANNAME" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtavTechnicianname_Jsonclick = "" ;
      edtavTechnicianname_Enabled = 1 ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11TechnicianName',fld:'vTECHNICIANNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e141A2',iparms:[{av:'A30TechnicianId',fld:'TECHNICIANID',pic:'ZZZ9',hsh:true},{av:'A12CountryId',fld:'COUNTRYID',pic:'ZZZ9'}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtTechnicianName_Link',ctrl:'TECHNICIANNAME',prop:'Link'},{av:'edtCountryName_Link',ctrl:'COUNTRYNAME',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e111A2',iparms:[{av:'A30TechnicianId',fld:'TECHNICIANID',pic:'ZZZ9',hsh:true}]");
      setEventMetadata("'DOINSERT'",",oparms:[]}");
      setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11TechnicianName',fld:'vTECHNICIANNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
      setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11TechnicianName',fld:'vTECHNICIANNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
      setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11TechnicianName',fld:'vTECHNICIANNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
      setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11TechnicianName',fld:'vTECHNICIANNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV11TechnicianName = "" ;
      H001A2_A24CityId = new short[1] ;
      H001A2_A12CountryId = new short[1] ;
      H001A2_A25CityName = new String[] {""} ;
      H001A2_A13CountryName = new String[] {""} ;
      H001A2_A33TechnicianPhone = new String[] {""} ;
      H001A2_A32TechnicianLastName = new String[] {""} ;
      H001A2_A31TechnicianName = new String[] {""} ;
      H001A2_A30TechnicianId = new short[1] ;
      ...
      ROClassString = "" ;
      gxphoneLink = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.parks.wwtechnician__default(),
         new Object[] {
             new Object[] {
            H001A2_A24CityId, H001A2_A12CountryId, H001A2_A25CityName, H001A2_A13CountryName, H001A2_A33TechnicianPhone, H001A2_A32TechnicianLastName, H001A2_A31TechnicianName, H001A2_A30TechnicianId
            }
            , new Object[] {
   ...
   private int edtavTechnicianname_Enabled ;
   ...
   private String AV11TechnicianName ;
   ...
   private String edtavTechnicianname_Internalname ;
   private String edtavTechnicianname_Jsonclick ;
   ...
   private String lV11TechnicianName ;
   ...
   private short[] H001A2_A24CityId ;
   private short[] H001A2_A12CountryId ;
   private String[] H001A2_A25CityName ;
   private String[] H001A2_A13CountryName ;
   private String[] H001A2_A33TechnicianPhone ;
   private String[] H001A2_A32TechnicianLastName ;
   private String[] H001A2_A31TechnicianName ;
   private short[] H001A2_A30TechnicianId ;
...
final  class wwtechnician__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          String A31TechnicianName )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " T1.`CityId`, T1.`CountryId`, T3.`CityName`, T2.`CountryName`, T1.`TechnicianPhone`, T1.`TechnicianLastName`, T1.`TechnicianName`, T1.`TechnicianId`" ;
      sFromString = " FROM ((`Technician` T1 INNER JOIN `Country` T2 ON T2.`CountryId` = T1.`CountryId`) INNER JOIN `CountryCity` T3 ON T3.`CountryId` = T1.`CountryId` AND T3.`CityId`" ;
      sFromString += " = T1.`CityId`)" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV11TechnicianName)==0) )
      {
         addWhere(sWhereString, "(T1.`TechnicianName` like ?)");
      }
      else
      {
         GXv_int1[0] = (byte)(1) ;
      }
      sOrderString += " ORDER BY T1.`TechnicianName`" ;
                                          ...
                                          String A31TechnicianName )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ((`Technician` T1 INNER JOIN `Country` T2 ON T2.`CountryId` = T1.`CountryId`) INNER JOIN `CountryCity` T3 ON T3.`CountryId` = T1.`CountryId`" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H001A2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
            case 1 :
                  return conditional_H001A3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
      }
