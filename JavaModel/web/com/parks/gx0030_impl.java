...
public final  class gx0030_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
         {
            ...
            AV6cCountryId = (short)(GXutil.lval( httpContext.GetPar( "cCountryId"))) ;
            AV7cCountryName = httpContext.GetPar( "cCountryName") ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            {
               GxWebError = (byte)(1) ;
            ...
            com.parks.GxWebStd.gx_hidden_field( httpContext, "COUNTRYNAMEFILTERCONTAINER_Class", GXutil.rtrim( divCountrynamefiltercontainer_Class));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2021102014432615", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.parks.gx0030", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8pCountryId,4,0))}, new String[] {"pCountryId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.parks.GxWebStd.gx_hidden_field( httpContext, "GXH_vCCOUNTRYID", GXutil.ltrim( localUtil.ntoc( AV6cCountryId, (byte)(4), (byte)(0), ",", "")));
      com.parks.GxWebStd.gx_hidden_field( httpContext, "GXH_vCCOUNTRYNAME", GXutil.rtrim( AV7cCountryName));
      /* Send saved values. */
   ...
   {
      return formatLink("com.parks.gx0030", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8pCountryId,4,0))}, new String[] {"pCountryId"})  ;
   }
   ...
   public void wb080( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.parks.GxWebStd.gx_label_ctrl( httpContext, lblLblcountryidfilter_Internalname, "Country Id", "", "", lblLblcountryidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11081_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0030.htm");
         ...
         com.parks.GxWebStd.gx_single_line_edit( httpContext, edtavCcountryid_Internalname, GXutil.ltrim( localUtil.ntoc( AV6cCountryId, (byte)(4), (byte)(0), ",", "")), ((edtavCcountryid_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV6cCountryId), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV6cCountryId), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcountryid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcountryid_Visible, edtavCcountryid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_Gx0030.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Div Control */
         com.parks.GxWebStd.gx_div_start( httpContext, divCountrynamefiltercontainer_Internalname, 1, 0, "px", 0, "px", divCountrynamefiltercontainer_Class, "left", "top", "", "", "div");
         /* Div Control */
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.parks.GxWebStd.gx_label_ctrl( httpContext, lblLblcountrynamefilter_Internalname, "Country Name", "", "", lblLblcountrynamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12081_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0030.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
         /* Attribute/Variable Label */
         com.parks.GxWebStd.gx_label_element( httpContext, edtavCcountryname_Internalname, "Country Name", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 26,'',false,'" + sGXsfl_34_idx + "',0)\"" ;
         com.parks.GxWebStd.gx_single_line_edit( httpContext, edtavCcountryname_Internalname, GXutil.rtrim( AV7cCountryName), GXutil.rtrim( localUtil.format( AV7cCountryName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcountryname_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcountryname_Visible, edtavCcountryname_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_Gx0030.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e13081_client"+"'", TempTags, "", 2, "HLP_Gx0030.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            Grid1Column.AddObjectProperty("Value", GXutil.rtrim( A13CountryName));
            Grid1Column.AddObjectProperty("Link", GXutil.rtrim( edtCountryName_Link));
            Grid1Container.AddColumnProperties(Grid1Column);
      ...
      if ( wbEnd == 34 )
      {
         ...
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0030.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start082( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selection List Country", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 if ( ! wbErr )
                                 {
                                    ...
                                    if ( localUtil.ctol( httpContext.cgiGet( "GXH_vCCOUNTRYID"), ",", ".") != AV6cCountryId )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    /* Set Refresh If Ccountryname Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vCCOUNTRYNAME"), AV7cCountryName) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, "gxhash_COUNTRYID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A12CountryId), "ZZZ9")));
   ...
   public void rf082( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV7cCountryName ,
                                              A13CountryName ,
                                              Short.valueOf(AV6cCountryId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT
                                              }
         });
         lV7cCountryName = GXutil.padr( GXutil.rtrim( AV7cCountryName), 50, "%") ;
         /* Using cursor H00082 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV6cCountryId), lV7cCountryName, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_34_idx = 1 ;
         sGXsfl_34_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_34_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_342( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subgrid1_fnc_recordsperpage( ) ) ) )
         {
            A13CountryName = H00082_A13CountryName[0] ;
            A12CountryId = H00082_A12CountryId[0] ;
            /* Execute user event: Load */
            e15082 ();
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, "gxhash_COUNTRYID"+"_"+sGXsfl_34_idx, getSecureSignedToken( sGXsfl_34_idx, localUtil.format( DecimalUtil.doubleToDec(A12CountryId), "ZZZ9")));
   }
   ...
   public int subgrid1_fnc_recordcount( )
   {
      ...
      lV7cCountryName = GXutil.padr( GXutil.rtrim( AV7cCountryName), 50, "%") ;
      /* Using cursor H00083 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV6cCountryId), lV7cCountryName});
   ...
   public void strup080( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavCcountryid_Internalname), ",", ".") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavCcountryid_Internalname), ",", ".") > 9999 ) ) )
         {
            ...
            wbErr = true ;
            AV6cCountryId = (short)(0) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6cCountryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6cCountryId), 4, 0));
         }
         else
         {
            AV6cCountryId = (short)(localUtil.ctol( httpContext.cgiGet( edtavCcountryid_Internalname), ",", ".")) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6cCountryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6cCountryId), 4, 0));
         }
         AV7cCountryName = httpContext.cgiGet( edtavCcountryname_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV7cCountryName", AV7cCountryName);
   ...
   public void e14082( )
   {
      /* Start Routine */
      returnInSub = false ;
      Form.setCaption( GXutil.format( "Lista de Selección %1", "Country", "", "", "", "", "", "", "", "") );
   ...
   public void e16082( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8pCountryId = A12CountryId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8pCountryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8pCountryId), 4, 0));
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV8pCountryId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8pCountryId"});
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2021102014432650", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0030.js", "?2021102014432651", false, true);
   ...
   public void sendrow_342( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subgrid1_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A12CountryId, (byte)(4), (byte)(0), ",", "")))+"'"+"]);" ;
         ...
         edtCountryName_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A12CountryId, (byte)(4), (byte)(0), ",", "")))+"'"+"]);" ;
         httpContext.ajax_rsp_assign_prop("", false, edtCountryName_Internalname, "Link", edtCountryName_Link, !bGXsfl_34_Refreshing);
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCountryName_Internalname,GXutil.rtrim( A13CountryName),"","","'"+""+"'"+",false,"+"'"+""+"'",edtCountryName_Link,"","","",edtCountryName_Jsonclick,Integer.valueOf(0),"DescriptionAttribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(50),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(34),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Name","left",Boolean.valueOf(true),""});
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Selection List Country" );
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("LBLCOUNTRYIDFILTER.CLICK","{handler:'e11081',iparms:[{av:'divCountryidfiltercontainer_Class',ctrl:'COUNTRYIDFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("LBLCOUNTRYNAMEFILTER.CLICK","{handler:'e12081',iparms:[{av:'divCountrynamefiltercontainer_Class',ctrl:'COUNTRYNAMEFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("ENTER","{handler:'e16082',iparms:[{av:'A12CountryId',fld:'COUNTRYID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV7cCountryName = "" ;
      H00082_A13CountryName = new String[] {""} ;
      H00082_A12CountryId = new short[1] ;
      ...
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.parks.gx0030__default(),
         new Object[] {
             new Object[] {
            H00082_A13CountryName, H00082_A12CountryId
            }
            , new Object[] {
   ...
   private String[] H00082_A13CountryName ;
   private short[] H00082_A12CountryId ;
...
final  class gx0030__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          short AV6cCountryId )
   {
      ...
      String sFromString;
      String sOrderString;
      sSelectString = " `CountryName`, `CountryId`" ;
      sFromString = " FROM `Country`" ;
      sOrderString = "" ;
      addWhere(sWhereString, "(`CountryId` >= ?)");
      if ( ! (GXutil.strcmp("", AV7cCountryName)==0) )
      {
         addWhere(sWhereString, "(`CountryName` like ?)");
      }
      else
      {
         GXv_int1[1] = (byte)(1) ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00082(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).shortValue() );
            case 1 :
                  return conditional_H00083(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).shortValue() );
      }
