...
public final  class gamerepairwc_impl extends GXWebComponent
{
   public gamerepairwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gamerepairwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gamerepairwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV6GameId = (short)(GXutil.lval( httpContext.GetPar( "GameId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6GameId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6GameId), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(AV6GameId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV6GameId, AV13Update, AV14Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Game Repair WC") ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.parks.gamerepairwc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV6GameId,4,0))}, new String[] {"GameId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV6GameId", GXutil.ltrim( localUtil.ntoc( wcpOAV6GameId, (byte)(4), (byte)(0), ",", "")));
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vGAMEID", GXutil.ltrim( localUtil.ntoc( AV6GameId, (byte)(4), (byte)(0), ",", "")));
   ...
   public void wb130( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.parks.gamerepairwc");
         }
         /* Div Control */
         ...
         ClassString = "BtnAdd" ;
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_GameRepairWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.parks.GxWebStd.gx_label_element( httpContext, edtGameId_Internalname, "Game Id", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         com.parks.GxWebStd.gx_single_line_edit( httpContext, edtGameId_Internalname, GXutil.ltrim( localUtil.ntoc( A17GameId, (byte)(4), (byte)(0), ",", "")), ((edtGameId_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A17GameId), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A17GameId), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtGameId_Jsonclick, 0, "Attribute", "", "", "", "", edtGameId_Visible, edtGameId_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id", "right", false, "", "HLP_GameRepairWC.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start132( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Game Repair WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void rf132( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H00133 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV6GameId), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_20_idx = 1 ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_20_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A17GameId = H00133_A17GameId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A17GameId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A17GameId), 4, 0));
            A38TechnicianAlternatePhone = H00133_A38TechnicianAlternatePhone[0] ;
            A37TechnicianAlternateLastName = H00133_A37TechnicianAlternateLastName[0] ;
            A36TechnicianAlternateName = H00133_A36TechnicianAlternateName[0] ;
            A35TechnicianAlternateId = H00133_A35TechnicianAlternateId[0] ;
            A32TechnicianLastName = H00133_A32TechnicianLastName[0] ;
            A31TechnicianName = H00133_A31TechnicianName[0] ;
            A30TechnicianId = H00133_A30TechnicianId[0] ;
            A27RepairId = H00133_A27RepairId[0] ;
            A42RepairProblems = H00133_A42RepairProblems[0] ;
            n42RepairProblems = H00133_n42RepairProblems[0] ;
            A29RepairDays = H00133_A29RepairDays[0] ;
            A28RepairBeginDate = H00133_A28RepairBeginDate[0] ;
            A39RepairDiscountPercentage = H00133_A39RepairDiscountPercentage[0] ;
            A34RepairCost = H00133_A34RepairCost[0] ;
            A38TechnicianAlternatePhone = H00133_A38TechnicianAlternatePhone[0] ;
            A37TechnicianAlternateLastName = H00133_A37TechnicianAlternateLastName[0] ;
            A36TechnicianAlternateName = H00133_A36TechnicianAlternateName[0] ;
            A32TechnicianLastName = H00133_A32TechnicianLastName[0] ;
   ...
   {
      /* Using cursor H00135 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV6GameId)});
      GRID_nRecordCount = H00135_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void strup130( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV6GameId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV6GameId"), ",", ".")) ;
   ...
   public void e12132( )
   {
      ...
      httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDelete_Internalname, AV14Delete);
      edtGameId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtGameId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtGameId_Visible), 5, 0), true);
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "GameId" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV6GameId, 4, 0) );
   ...
   {
      AV6GameId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6GameId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6GameId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV6GameId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "gamerepairwc", GetJustCreated( ));
      ...
      {
         AV6GameId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6GameId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6GameId), 4, 0));
      }
      wcpOAV6GameId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV6GameId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV6GameId != wcpOAV6GameId ) ) )
      {
         setjustcreated();
      }
      wcpOAV6GameId = AV6GameId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV6GameId = httpContext.cgiGet( sPrefix+"AV6GameId_CTRL") ;
      if ( GXutil.len( sCtrlAV6GameId) > 0 )
      {
         AV6GameId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV6GameId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6GameId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6GameId), 4, 0));
      }
      else
      {
         AV6GameId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV6GameId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6GameId_PARM", GXutil.ltrim( localUtil.ntoc( AV6GameId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV6GameId)) > 0 )
      {
         com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6GameId_CTRL", GXutil.rtrim( sCtrlAV6GameId));
      }
   }
   ...
   public void subsflControlProps_202( )
   {
      ...
      edtTechnicianId_Internalname = sPrefix+"TECHNICIANID_"+sGXsfl_20_idx ;
      edtTechnicianName_Internalname = sPrefix+"TECHNICIANNAME_"+sGXsfl_20_idx ;
      edtTechnicianLastName_Internalname = sPrefix+"TECHNICIANLASTNAME_"+sGXsfl_20_idx ;
   ...
   public void subsflControlProps_fel_202( )
   {
      ...
      edtTechnicianId_Internalname = sPrefix+"TECHNICIANID_"+sGXsfl_20_fel_idx ;
      edtTechnicianName_Internalname = sPrefix+"TECHNICIANNAME_"+sGXsfl_20_fel_idx ;
      edtTechnicianLastName_Internalname = sPrefix+"TECHNICIANLASTNAME_"+sGXsfl_20_fel_idx ;
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTechnicianId_Internalname,GXutil.ltrim( localUtil.ntoc( A30TechnicianId, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A30TechnicianId), "ZZZ9"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtTechnicianId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"number","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(20),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6GameId',fld:'vGAMEID',pic:'ZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e13132',iparms:[{av:'A27RepairId',fld:'REPAIRID',pic:'ZZZ9',hsh:true},{av:'A30TechnicianId',fld:'TECHNICIANID',pic:'ZZZ9'}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtRepairBeginDate_Link',ctrl:'REPAIRBEGINDATE',prop:'Link'},{av:'edtTechnicianName_Link',ctrl:'TECHNICIANNAME',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e11132',iparms:[{av:'A27RepairId',fld:'REPAIRID',pic:'ZZZ9',hsh:true}]");
      setEventMetadata("'DOINSERT'",",oparms:[]}");
      setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6GameId',fld:'vGAMEID',pic:'ZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
      setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6GameId',fld:'vGAMEID',pic:'ZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
      setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6GameId',fld:'vGAMEID',pic:'ZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
      setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6GameId',fld:'vGAMEID',pic:'ZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H00133_A17GameId = new short[1] ;
      H00133_A38TechnicianAlternatePhone = new String[] {""} ;
      H00133_A37TechnicianAlternateLastName = new String[] {""} ;
      H00133_A36TechnicianAlternateName = new String[] {""} ;
      H00133_A35TechnicianAlternateId = new short[1] ;
      H00133_A32TechnicianLastName = new String[] {""} ;
      H00133_A31TechnicianName = new String[] {""} ;
      H00133_A30TechnicianId = new short[1] ;
      H00133_A27RepairId = new short[1] ;
      H00133_A42RepairProblems = new byte[1] ;
      H00133_n42RepairProblems = new boolean[] {false} ;
      H00133_A29RepairDays = new short[1] ;
      H00133_A28RepairBeginDate = new java.util.Date[] {GXutil.nullDate()} ;
      H00133_A39RepairDiscountPercentage = new short[1] ;
      H00133_A34RepairCost = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00135_AGRID_nRecordCount = new long[1] ;
      ...
      ROClassString = "" ;
      gxphoneLink = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.parks.gamerepairwc__default(),
         new Object[] {
             new Object[] {
            H00133_A17GameId, H00133_A38TechnicianAlternatePhone, H00133_A37TechnicianAlternateLastName, H00133_A36TechnicianAlternateName, H00133_A35TechnicianAlternateId, H00133_A32TechnicianLastName, H00133_A31TechnicianName, H00133_A30TechnicianId, H00133_A27RepairId, H00133_A42RepairProblems,
            H00133_n42RepairProblems, H00133_A29RepairDays, H00133_A28RepairBeginDate, H00133_A39RepairDiscountPercentage, H00133_A34RepairCost
            }
            , new Object[] {
            H00135_AGRID_nRecordCount
            }
         }
      );
      AV17Pgmname = "GameRepairWC" ;
   ...
   private short[] H00133_A17GameId ;
   private String[] H00133_A38TechnicianAlternatePhone ;
   private String[] H00133_A37TechnicianAlternateLastName ;
   private String[] H00133_A36TechnicianAlternateName ;
   private short[] H00133_A35TechnicianAlternateId ;
   private String[] H00133_A32TechnicianLastName ;
   private String[] H00133_A31TechnicianName ;
   private short[] H00133_A30TechnicianId ;
   private short[] H00133_A27RepairId ;
   private byte[] H00133_A42RepairProblems ;
   private boolean[] H00133_n42RepairProblems ;
   private short[] H00133_A29RepairDays ;
   private java.util.Date[] H00133_A28RepairBeginDate ;
   private short[] H00133_A39RepairDiscountPercentage ;
   private java.math.BigDecimal[] H00133_A34RepairCost ;
   private long[] H00135_AGRID_nRecordCount ;
...
final  class gamerepairwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00133", "SELECT T1.`GameId`, T2.`TechnicianPhone` AS TechnicianAlternatePhone, T2.`TechnicianLastName` AS TechnicianAlternateLastName, T2.`TechnicianName` AS TechnicianAlternateName, T1.`TechnicianAlternateId` AS TechnicianAlternateId, T3.`TechnicianLastName`, T3.`TechnicianName`, T1.`TechnicianId`, T1.`RepairId`, COALESCE( T4.`RepairProblems`, 0) AS RepairProblems, T1.`RepairDays`, T1.`RepairBeginDate`, T1.`RepairDiscountPercentage`, T1.`RepairCost` FROM (((`Repair` T1 INNER JOIN `Technician` T2 ON T2.`TechnicianId` = T1.`TechnicianAlternateId`) INNER JOIN `Technician` T3 ON T3.`TechnicianId` = T1.`TechnicianId`) LEFT JOIN (SELECT COUNT(*) AS RepairProblems, `RepairId` FROM `RepairKind` GROUP BY `RepairId` ) T4 ON T4.`RepairId` = T1.`RepairId`) WHERE T1.`GameId` = ? ORDER BY T1.`GameId`  LIMIT ?, ?",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H00135", "SELECT COUNT(*) FROM (((`Repair` T1 INNER JOIN `Technician` T3 ON T3.`TechnicianId` = T1.`TechnicianAlternateId`) INNER JOIN `Technician` T2 ON T2.`TechnicianId` = T1.`TechnicianId`) LEFT JOIN (SELECT COUNT(*) AS RepairProblems, `RepairId` FROM `RepairKind` GROUP BY `RepairId` ) T4 ON T4.`RepairId` = T1.`RepairId`) WHERE T1.`GameId` = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
