...
public final  class gx0060_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         gxfirstwebparm = httpContext.GetFirstPar( "pCategoryId") ;
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
         {
            ...
            AV6cCategoryId = (short)(GXutil.lval( httpContext.GetPar( "cCategoryId"))) ;
            AV7cCategoryName = httpContext.GetPar( "cCategoryName") ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            {
               GxWebError = (byte)(1) ;
            ...
            com.parks.GxWebStd.gx_hidden_field( httpContext, "CATEGORYNAMEFILTERCONTAINER_Class", GXutil.rtrim( divCategorynamefiltercontainer_Class));
         ...
         {
            AV8pCategoryId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV8pCategoryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8pCategoryId), 4, 0));
         }
         if ( toggleJsOutput )
         {
            if ( httpContext.isSpaRequest( ) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20211071155106", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.parks.gx0060", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8pCategoryId,4,0))}, new String[] {"pCategoryId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.parks.GxWebStd.gx_hidden_field( httpContext, "GXH_vCCATEGORYID", GXutil.ltrim( localUtil.ntoc( AV6cCategoryId, (byte)(4), (byte)(0), ",", "")));
      com.parks.GxWebStd.gx_hidden_field( httpContext, "GXH_vCCATEGORYNAME", GXutil.rtrim( AV7cCategoryName));
      /* Send saved values. */
      send_integrity_footer_hashes( ) ;
      com.parks.GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_34", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_34, (byte)(8), (byte)(0), ",", "")));
      com.parks.GxWebStd.gx_hidden_field( httpContext, "vPCATEGORYID", GXutil.ltrim( localUtil.ntoc( AV8pCategoryId, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return formatLink("com.parks.gx0060", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV8pCategoryId,4,0))}, new String[] {"pCategoryId"})  ;
   }
   ...
   public void wb0C0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.parks.GxWebStd.gx_label_ctrl( httpContext, lblLblcategoryidfilter_Internalname, "Category Id", "", "", lblLblcategoryidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110c1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0060.htm");
         ...
         com.parks.GxWebStd.gx_single_line_edit( httpContext, edtavCcategoryid_Internalname, GXutil.ltrim( localUtil.ntoc( AV6cCategoryId, (byte)(4), (byte)(0), ",", "")), ((edtavCcategoryid_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV6cCategoryId), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV6cCategoryId), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcategoryid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcategoryid_Visible, edtavCcategoryid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_Gx0060.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Div Control */
         com.parks.GxWebStd.gx_div_start( httpContext, divCategorynamefiltercontainer_Internalname, 1, 0, "px", 0, "px", divCategorynamefiltercontainer_Class, "left", "top", "", "", "div");
         /* Div Control */
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.parks.GxWebStd.gx_label_ctrl( httpContext, lblLblcategorynamefilter_Internalname, "Category Name", "", "", lblLblcategorynamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120c1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx0060.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
         /* Attribute/Variable Label */
         com.parks.GxWebStd.gx_label_element( httpContext, edtavCcategoryname_Internalname, "Category Name", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 26,'',false,'" + sGXsfl_34_idx + "',0)\"" ;
         com.parks.GxWebStd.gx_single_line_edit( httpContext, edtavCcategoryname_Internalname, GXutil.rtrim( AV7cCategoryName), GXutil.rtrim( localUtil.format( AV7cCategoryName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcategoryname_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcategoryname_Visible, edtavCcategoryname_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_Gx0060.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e130c1_client"+"'", TempTags, "", 2, "HLP_Gx0060.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            Grid1Column.AddObjectProperty("Value", GXutil.rtrim( A20CategoryName));
            Grid1Column.AddObjectProperty("Link", GXutil.rtrim( edtCategoryName_Link));
            Grid1Container.AddColumnProperties(Grid1Column);
      ...
      if ( wbEnd == 34 )
      {
         ...
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0060.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start0C2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selection List Category", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 if ( ! wbErr )
                                 {
                                    ...
                                    if ( localUtil.ctol( httpContext.cgiGet( "GXH_vCCATEGORYID"), ",", ".") != AV6cCategoryId )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    /* Set Refresh If Ccategoryname Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vCCATEGORYNAME"), AV7cCategoryName) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, "gxhash_CATEGORYID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A19CategoryId), "ZZZ9")));
      com.parks.GxWebStd.gx_hidden_field( httpContext, "CATEGORYID", GXutil.ltrim( localUtil.ntoc( A19CategoryId, (byte)(4), (byte)(0), ".", "")));
   }
   ...
   public void rf0C2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV7cCategoryName ,
                                              A20CategoryName ,
                                              Short.valueOf(AV6cCategoryId) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT
                                              }
         });
         lV7cCategoryName = GXutil.padr( GXutil.rtrim( AV7cCategoryName), 50, "%") ;
         /* Using cursor H000C2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV6cCategoryId), lV7cCategoryName, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_34_idx = 1 ;
         sGXsfl_34_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_34_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_342( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subgrid1_fnc_recordsperpage( ) ) ) )
         {
            A20CategoryName = H000C2_A20CategoryName[0] ;
            A19CategoryId = H000C2_A19CategoryId[0] ;
            /* Execute user event: Load */
            e150C2 ();
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, "gxhash_CATEGORYID"+"_"+sGXsfl_34_idx, getSecureSignedToken( sGXsfl_34_idx, localUtil.format( DecimalUtil.doubleToDec(A19CategoryId), "ZZZ9")));
   }
   ...
   public int subgrid1_fnc_recordcount( )
   {
      ...
      lV7cCategoryName = GXutil.padr( GXutil.rtrim( AV7cCategoryName), 50, "%") ;
      /* Using cursor H000C3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV6cCategoryId), lV7cCategoryName});
   ...
   public void strup0C0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavCcategoryid_Internalname), ",", ".") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavCcategoryid_Internalname), ",", ".") > 9999 ) ) )
         {
            ...
            wbErr = true ;
            AV6cCategoryId = (short)(0) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6cCategoryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6cCategoryId), 4, 0));
         }
         else
         {
            AV6cCategoryId = (short)(localUtil.ctol( httpContext.cgiGet( edtavCcategoryid_Internalname), ",", ".")) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6cCategoryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6cCategoryId), 4, 0));
         }
         AV7cCategoryName = httpContext.cgiGet( edtavCcategoryname_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV7cCategoryName", AV7cCategoryName);
   ...
   public void e140C2( )
   {
      /* Start Routine */
      returnInSub = false ;
      Form.setCaption( GXutil.format( "Lista de Selección %1", "Category", "", "", "", "", "", "", "", "") );
   ...
   public void e160C2( )
   {
      /* Enter Routine */
      returnInSub = false ;
      AV8pCategoryId = A19CategoryId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8pCategoryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8pCategoryId), 4, 0));
      httpContext.setWebReturnParms(new Object[] {Short.valueOf(AV8pCategoryId)});
      httpContext.setWebReturnParmsMetadata(new Object[] {"AV8pCategoryId"});
   ...
   {
      AV8pCategoryId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8pCategoryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8pCategoryId), 4, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202110711551039", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0060.js", "?202110711551039", false, true);
   ...
   public void sendrow_342( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subgrid1_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A19CategoryId, (byte)(4), (byte)(0), ",", "")))+"'"+"]);" ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Selection List Category" );
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'TOGGLE'","{handler:'e130C1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
      setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLCATEGORYIDFILTER.CLICK","{handler:'e110C1',iparms:[{av:'divCategoryidfiltercontainer_Class',ctrl:'CATEGORYIDFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("LBLCATEGORYNAMEFILTER.CLICK","{handler:'e120C1',iparms:[{av:'divCategorynamefiltercontainer_Class',ctrl:'CATEGORYNAMEFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("ENTER","{handler:'e160C2',iparms:[{av:'A19CategoryId',fld:'CATEGORYID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV7cCategoryName = "" ;
      H000C2_A20CategoryName = new String[] {""} ;
      H000C2_A19CategoryId = new short[1] ;
      ...
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.parks.gx0060__default(),
         new Object[] {
             new Object[] {
            H000C2_A20CategoryName, H000C2_A19CategoryId
            }
            , new Object[] {
   ...
   private String[] H000C2_A20CategoryName ;
   private short[] H000C2_A19CategoryId ;
...
final  class gx0060__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          short AV6cCategoryId )
   {
      ...
      if ( ! (GXutil.strcmp("", AV7cCategoryName)==0) )
      {
         addWhere(sWhereString, "(`CategoryName` like ?)");
      }
      else
      {
         GXv_int1[1] = (byte)(1) ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000C2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).shortValue() );
            case 1 :
                  return conditional_H000C3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , ((Number) dynConstraints[2]).shortValue() );
      }
