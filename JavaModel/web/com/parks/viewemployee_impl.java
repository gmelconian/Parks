...
public final  class viewemployee_impl extends GXDataArea
{
   public viewemployee_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewemployee_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewemployee_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV12EmployeeId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV12EmployeeId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12EmployeeId), 4, 0));
            com.parks.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPLOYEEID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12EmployeeId), "ZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2021102014432363", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.parks.viewemployee", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12EmployeeId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV6TabCode))}, new String[] {"EmployeeId","TabCode"}) +"\">") ;
   ...
   public void send_integrity_footer_hashes( )
   {
      ...
      forbiddenHiddens.add("EmployeeName", GXutil.rtrim( localUtil.format( A2EmployeeName, "")));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.parks.GxWebStd.gx_hidden_field( httpContext, "vEMPLOYEEID", GXutil.ltrim( localUtil.ntoc( AV12EmployeeId, (byte)(4), (byte)(0), ",", "")));
      com.parks.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPLOYEEID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12EmployeeId), "ZZZ9")));
   ...
   {
      return formatLink("com.parks.viewemployee", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV12EmployeeId,4,0)),GXutil.URLEncode(GXutil.rtrim(AV6TabCode))}, new String[] {"EmployeeId","TabCode"})  ;
   }
   ...
   public void wb0U0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.parks.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "Employee Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, (short)(0), "HLP_ViewEmployee.htm");
         ...
         /* Text block */
         com.parks.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Employees", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, (short)(0), "HLP_ViewEmployee.htm");
         ...
         /* Single line edit */
         com.parks.GxWebStd.gx_single_line_edit( httpContext, edtEmployeeName_Internalname, GXutil.rtrim( A2EmployeeName), GXutil.rtrim( localUtil.format( A2EmployeeName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmployeeName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtEmployeeName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Name", "left", true, "", "HLP_ViewEmployee.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.parks.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_ViewEmployee.htm");
         /* Div Control */
   ...
   public void start0U2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View Employee", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf0U2( )
   {
      ...
      {
         /* Using cursor H000U2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV12EmployeeId)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A1EmployeeId = H000U2_A1EmployeeId[0] ;
            A2EmployeeName = H000U2_A2EmployeeName[0] ;
   ...
   public void strup0U0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         AV12EmployeeId = (short)(localUtil.ctol( httpContext.cgiGet( "vEMPLOYEEID"), ",", ".")) ;
   ...
   public void e110U2( )
   {
      ...
      AV16GXLvl6 = (byte)(0) ;
      /* Using cursor H000U3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV12EmployeeId)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A1EmployeeId = H000U3_A1EmployeeId[0] ;
         A2EmployeeName = H000U3_A2EmployeeName[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A2EmployeeName", A2EmployeeName);
         AV16GXLvl6 = (byte)(1) ;
         Form.setCaption( A2EmployeeName );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.parks.wwemployee", new String[] {}, new String[] {})  ;
   ...
   public void S112( )
   {
      ...
      if ( AV11LoadAllTabs || ( GXutil.strcmp(AV7SelectedTabCode, "") == 0 ) || ( GXutil.strcmp(AV7SelectedTabCode, "General") == 0 ) )
      {
         ...
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "EmployeeGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.parks.employeegeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "EmployeeGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0030","",Short.valueOf(AV12EmployeeId)});
   ...
   {
      AV12EmployeeId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12EmployeeId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV12EmployeeId), 4, 0));
      com.parks.GxWebStd.gx_hidden_field( httpContext, "gxhash_vEMPLOYEEID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12EmployeeId), "ZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2021102014432388", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewemployee.js", "?2021102014432388", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'AV12EmployeeId',fld:'vEMPLOYEEID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A2EmployeeName',fld:'EMPLOYEENAME',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      AV15Pgmname = "" ;
      scmdbuf = "" ;
      H000U2_A1EmployeeId = new short[1] ;
      H000U2_A2EmployeeName = new String[] {""} ;
      hsh = "" ;
      H000U3_A1EmployeeId = new short[1] ;
      H000U3_A2EmployeeName = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.parks.viewemployee__default(),
         new Object[] {
             new Object[] {
            H000U2_A1EmployeeId, H000U2_A2EmployeeName
            }
            , new Object[] {
            H000U3_A1EmployeeId, H000U3_A2EmployeeName
            }
         }
      );
      AV15Pgmname = "ViewEmployee" ;
   ...
   private short[] H000U2_A1EmployeeId ;
   private String[] H000U2_A2EmployeeName ;
   private short[] H000U3_A1EmployeeId ;
   private String[] H000U3_A2EmployeeName ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class viewemployee__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000U2", "SELECT `EmployeeId`, `EmployeeName` FROM `Employee` WHERE `EmployeeId` = ? ORDER BY `EmployeeId` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
         ,new ForEachCursor("H000U3", "SELECT `EmployeeId`, `EmployeeName` FROM `Employee` WHERE `EmployeeId` = ? ORDER BY `EmployeeId` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
