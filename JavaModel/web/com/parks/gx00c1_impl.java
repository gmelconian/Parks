...
public final  class gx00c1_impl extends GXDataArea
{
   public gx00c1_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gx00c1_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gx00c1_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
         {
            ...
            AV7pAmusementParkId = (short)(GXutil.lval( httpContext.GetPar( "pAmusementParkId"))) ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            {
               GxWebError = (byte)(1) ;
            ...
            gxgrgrid1_refresh( subGrid1_Rows, AV6cShowId, AV7pAmusementParkId) ;
         ...
         {
            AV7pAmusementParkId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV7pAmusementParkId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV7pAmusementParkId), 4, 0));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV8pShowId = (short)(GXutil.lval( httpContext.GetPar( "pShowId"))) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2021102014432819", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.parks.gx00c1", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV7pAmusementParkId,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV8pShowId,4,0))}, new String[] {"pAmusementParkId","pShowId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.parks.GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_24", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_24, (byte)(8), (byte)(0), ",", "")));
      com.parks.GxWebStd.gx_hidden_field( httpContext, "vPAMUSEMENTPARKID", GXutil.ltrim( localUtil.ntoc( AV7pAmusementParkId, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return formatLink("com.parks.gx00c1", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV7pAmusementParkId,4,0)),GXutil.URLEncode(GXutil.ltrimstr(AV8pShowId,4,0))}, new String[] {"pAmusementParkId","pShowId"})  ;
   }
   ...
   public void wb1K0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.parks.GxWebStd.gx_label_ctrl( httpContext, lblLblshowidfilter_Internalname, "Show Id", "", "", lblLblshowidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e111k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, (short)(1), "HLP_Gx00C1.htm");
         ...
         com.parks.GxWebStd.gx_single_line_edit( httpContext, edtavCshowid_Internalname, GXutil.ltrim( localUtil.ntoc( AV6cShowId, (byte)(4), (byte)(0), ",", "")), ((edtavCshowid_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV6cShowId), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV6cShowId), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCshowid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCshowid_Visible, edtavCshowid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_Gx00C1.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 24, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e121k1_client"+"'", TempTags, "", 2, "HLP_Gx00C1.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         else
         {
            ...
            Grid1Column.AddObjectProperty("Link", GXutil.rtrim( edtShowId_Link));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
      ...
      if ( wbEnd == 24 )
      {
         ...
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 24, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx00C1.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void rf1K2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H001K2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV7pAmusementParkId), Short.valueOf(AV6cShowId), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_24_idx = 1 ;
         sGXsfl_24_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_24_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_242( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subgrid1_fnc_recordsperpage( ) ) ) )
         {
            A7AmusementParkId = H001K2_A7AmusementParkId[0] ;
            A14ShowId = H001K2_A14ShowId[0] ;
            /* Execute user event: Load */
            e141K2 ();
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, "gxhash_SHOWID"+"_"+sGXsfl_24_idx, getSecureSignedToken( sGXsfl_24_idx, localUtil.format( DecimalUtil.doubleToDec(A14ShowId), "ZZZ9")));
   }
   ...
   {
      /* Using cursor H001K3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV7pAmusementParkId), Short.valueOf(AV6cShowId)});
   ...
   {
      AV7pAmusementParkId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV7pAmusementParkId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV7pAmusementParkId), 4, 0));
      AV8pShowId = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8pShowId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV8pShowId), 4, 0));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2021102014432846", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx00c1.js", "?2021102014432846", false, true);
   ...
   public void subsflControlProps_242( )
   {
      ...
      edtShowId_Internalname = "SHOWID_"+sGXsfl_24_idx ;
   ...
   public void subsflControlProps_fel_242( )
   {
      ...
      edtShowId_Internalname = "SHOWID_"+sGXsfl_24_fel_idx ;
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid1_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         edtShowId_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A14ShowId, (byte)(4), (byte)(0), ",", "")))+"'"+"]);" ;
         httpContext.ajax_rsp_assign_prop("", false, edtShowId_Internalname, "Link", edtShowId_Link, !bGXsfl_24_Refreshing);
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtShowId_Internalname,GXutil.ltrim( localUtil.ntoc( A14ShowId, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A14ShowId), "ZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'",edtShowId_Link,"","","",edtShowId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"number","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(24),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( Grid1Container.GetWrapped() == 1 )
         {
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cShowId',fld:'vCSHOWID',pic:'ZZZ9'},{av:'AV7pAmusementParkId',fld:'vPAMUSEMENTPARKID',pic:'ZZZ9'}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("'TOGGLE'","{handler:'e121K1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
      setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLSHOWIDFILTER.CLICK","{handler:'e111K1',iparms:[{av:'divShowidfiltercontainer_Class',ctrl:'SHOWIDFILTERCONTAINER',prop:'Class'}]");
      ...
      setEventMetadata("ENTER","{handler:'e151K2',iparms:[{av:'A14ShowId',fld:'SHOWID',pic:'ZZZ9',hsh:true}]");
      setEventMetadata("ENTER",",oparms:[{av:'AV8pShowId',fld:'vPSHOWID',pic:'ZZZ9'}]}");
      setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cShowId',fld:'vCSHOWID',pic:'ZZZ9'},{av:'AV7pAmusementParkId',fld:'vPAMUSEMENTPARKID',pic:'ZZZ9'}]");
      setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
      setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cShowId',fld:'vCSHOWID',pic:'ZZZ9'},{av:'AV7pAmusementParkId',fld:'vPAMUSEMENTPARKID',pic:'ZZZ9'}]");
      setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
      setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cShowId',fld:'vCSHOWID',pic:'ZZZ9'},{av:'AV7pAmusementParkId',fld:'vPAMUSEMENTPARKID',pic:'ZZZ9'}]");
      setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
      setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cShowId',fld:'vCSHOWID',pic:'ZZZ9'},{av:'AV7pAmusementParkId',fld:'vPAMUSEMENTPARKID',pic:'ZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H001K2_A7AmusementParkId = new short[1] ;
      H001K2_A14ShowId = new short[1] ;
      ...
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.parks.gx00c1__default(),
         new Object[] {
             new Object[] {
            H001K2_A7AmusementParkId, H001K2_A14ShowId
            }
            , new Object[] {
   ...
   private short wcpOAV7pAmusementParkId ;
   private short AV6cShowId ;
   private short AV7pAmusementParkId ;
   ...
   private short[] H001K2_A7AmusementParkId ;
   private short[] H001K2_A14ShowId ;
   private long[] H001K3_AGRID1_nRecordCount ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class gx00c1__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001K2", "SELECT `AmusementParkId`, `ShowId` FROM `AmusementParkShow` WHERE `AmusementParkId` = ? and `ShowId` >= ? ORDER BY `AmusementParkId`, `ShowId`  LIMIT ?, ?",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H001K3", "SELECT COUNT(*) FROM `AmusementParkShow` WHERE `AmusementParkId` = ? and `ShowId` >= ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
