...
public final  class categorygamewc_impl extends GXWebComponent
{
   public categorygamewc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public categorygamewc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( categorygamewc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Category Game WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2021102014431810", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.parks.categorygamewc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV6CategoryId,4,0))}, new String[] {"CategoryId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV6CategoryId", GXutil.ltrim( localUtil.ntoc( wcpOAV6CategoryId, (byte)(4), (byte)(0), ",", "")));
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vCATEGORYID", GXutil.ltrim( localUtil.ntoc( AV6CategoryId, (byte)(4), (byte)(0), ",", "")));
   ...
   public void wb0P0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.parks.categorygamewc");
         }
         /* Div Control */
         ...
         ClassString = "BtnAdd" ;
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_CategoryGameWC.htm");
   ...
   public void start0P2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Category Game WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void rf0P2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H000P2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV6CategoryId), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_20_idx = 1 ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_20_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A19CategoryId = H000P2_A19CategoryId[0] ;
            n19CategoryId = H000P2_n19CategoryId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A19CategoryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A19CategoryId), 4, 0));
            A21GamePhoto = H000P2_A21GamePhoto[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtGamePhoto_Internalname, "Bitmap", ((GXutil.strcmp("", A21GamePhoto)==0) ? A40000GamePhoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A21GamePhoto))), !bGXsfl_20_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtGamePhoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A21GamePhoto), true);
            A40000GamePhoto_GXI = H000P2_A40000GamePhoto_GXI[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtGamePhoto_Internalname, "Bitmap", ((GXutil.strcmp("", A21GamePhoto)==0) ? A40000GamePhoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A21GamePhoto))), !bGXsfl_20_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtGamePhoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A21GamePhoto), true);
            A8AmusementParkName = H000P2_A8AmusementParkName[0] ;
            A7AmusementParkId = H000P2_A7AmusementParkId[0] ;
            A18GameName = H000P2_A18GameName[0] ;
            A17GameId = H000P2_A17GameId[0] ;
            A8AmusementParkName = H000P2_A8AmusementParkName[0] ;
            e130P2 ();
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "categorygamewc", GetJustCreated( ));
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6CategoryId_PARM", GXutil.ltrim( localUtil.ntoc( AV6CategoryId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV6CategoryId)) > 0 )
      {
         com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6CategoryId_CTRL", GXutil.rtrim( sCtrlAV6CategoryId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2021102014431855", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("categorygamewc.js", "?2021102014431855", false, true);
      }
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e130P2',iparms:[{av:'A17GameId',fld:'GAMEID',pic:'ZZZ9',hsh:true},{av:'A7AmusementParkId',fld:'AMUSEMENTPARKID',pic:'ZZZ9'}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtGameName_Link',ctrl:'GAMENAME',prop:'Link'},{av:'edtAmusementParkName_Link',ctrl:'AMUSEMENTPARKNAME',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e110P2',iparms:[{av:'A17GameId',fld:'GAMEID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H000P2_A19CategoryId = new short[1] ;
      H000P2_n19CategoryId = new boolean[] {false} ;
      H000P2_A21GamePhoto = new String[] {""} ;
      H000P2_A40000GamePhoto_GXI = new String[] {""} ;
      H000P2_A8AmusementParkName = new String[] {""} ;
      H000P2_A7AmusementParkId = new short[1] ;
      H000P2_A18GameName = new String[] {""} ;
      H000P2_A17GameId = new short[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.parks.categorygamewc__default(),
         new Object[] {
             new Object[] {
            H000P2_A19CategoryId, H000P2_n19CategoryId, H000P2_A21GamePhoto, H000P2_A40000GamePhoto_GXI, H000P2_A8AmusementParkName, H000P2_A7AmusementParkId, H000P2_A18GameName, H000P2_A17GameId
            }
            , new Object[] {
   ...
   private short[] H000P2_A19CategoryId ;
   private boolean[] H000P2_n19CategoryId ;
   private String[] H000P2_A21GamePhoto ;
   private String[] H000P2_A40000GamePhoto_GXI ;
   private String[] H000P2_A8AmusementParkName ;
   private short[] H000P2_A7AmusementParkId ;
   private String[] H000P2_A18GameName ;
   private short[] H000P2_A17GameId ;
...
final  class categorygamewc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000P2", "SELECT T1.`CategoryId`, T1.`GamePhoto`, T1.`GamePhoto_GXI`, T2.`AmusementParkName`, T1.`AmusementParkId`, T1.`GameName`, T1.`GameId` FROM (`Game` T1 INNER JOIN `AmusementPark` T2 ON T2.`AmusementParkId` = T1.`AmusementParkId`) WHERE T1.`CategoryId` = ? ORDER BY T1.`CategoryId`  LIMIT ?, ?",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H000P3", "SELECT COUNT(*) FROM (`Game` T1 INNER JOIN `AmusementPark` T2 ON T2.`AmusementParkId` = T1.`AmusementParkId`) WHERE T1.`CategoryId` = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
