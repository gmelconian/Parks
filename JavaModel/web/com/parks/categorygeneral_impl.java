...
public final  class categorygeneral_impl extends GXWebComponent
{
   public categorygeneral_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public categorygeneral_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( categorygeneral_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(A19CategoryId)});
               componentstart();
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Category General") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20211071155280", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.parks.categorygeneral", new String[] {GXutil.URLEncode(GXutil.ltrimstr(A19CategoryId,4,0))}, new String[] {"CategoryId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOA19CategoryId", GXutil.ltrim( localUtil.ntoc( wcpOA19CategoryId, (byte)(4), (byte)(0), ",", "")));
   }
   ...
   public void wb0O0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.parks.categorygeneral");
         }
         ...
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", "Modificar", bttBtnupdate_Jsonclick, 7, "Modificar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110o1_client"+"'", TempTags, "", 2, "HLP_CategoryGeneral.htm");
         ...
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e120o1_client"+"'", TempTags, "", 2, "HLP_CategoryGeneral.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.parks.GxWebStd.gx_label_element( httpContext, edtCategoryId_Internalname, "Id", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
         /* Div Control */
         ...
         com.parks.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         com.parks.GxWebStd.gx_single_line_edit( httpContext, edtCategoryName_Internalname, GXutil.rtrim( A20CategoryName), GXutil.rtrim( localUtil.format( A20CategoryName, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCategoryName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtCategoryName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Name", "left", true, "", "HLP_CategoryGeneral.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start0O2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Category General", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void rf0O2( )
   {
      ...
      {
         /* Using cursor H000O2 */
         pr_default.execute(0, new Object[] {Short.valueOf(A19CategoryId)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A20CategoryName = H000O2_A20CategoryName[0] ;
   ...
   public void strup0O0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         /* Read saved SDTs. */
         /* Read saved values. */
         wcpOA19CategoryId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA19CategoryId"), ",", ".")) ;
   ...
   public void S112( )
   {
      ...
      AV7TrnContext.setgxTv_SdtTransactionContext_Transactionname( "Category" );
      ...
      AV8TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "CategoryId" );
      AV8TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV6CategoryId, 4, 0) );
   ...
   {
      A19CategoryId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "A19CategoryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A19CategoryId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlA19CategoryId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "categorygeneral", GetJustCreated( ));
      ...
      {
         A19CategoryId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A19CategoryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A19CategoryId), 4, 0));
      }
      wcpOA19CategoryId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOA19CategoryId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( A19CategoryId != wcpOA19CategoryId ) ) )
      {
         setjustcreated();
      }
      wcpOA19CategoryId = A19CategoryId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlA19CategoryId = httpContext.cgiGet( sPrefix+"A19CategoryId_CTRL") ;
      if ( GXutil.len( sCtrlA19CategoryId) > 0 )
      {
         A19CategoryId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlA19CategoryId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "A19CategoryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(A19CategoryId), 4, 0));
      }
      else
      {
         A19CategoryId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"A19CategoryId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"A19CategoryId_PARM", GXutil.ltrim( localUtil.ntoc( A19CategoryId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlA19CategoryId)) > 0 )
      {
         com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"A19CategoryId_CTRL", GXutil.rtrim( sCtrlA19CategoryId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20211071155299", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("categorygeneral.js", "?20211071155299", false, true);
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'A19CategoryId',fld:'CATEGORYID',pic:'ZZZ9'}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("'DOUPDATE'","{handler:'e110O1',iparms:[{av:'A19CategoryId',fld:'CATEGORYID',pic:'ZZZ9'}]");
      setEventMetadata("'DOUPDATE'",",oparms:[]}");
      setEventMetadata("'DODELETE'","{handler:'e120O1',iparms:[{av:'A19CategoryId',fld:'CATEGORYID',pic:'ZZZ9'}]");
   ...
   public void initialize( )
   {
      ...
      AV13Pgmname = "" ;
      scmdbuf = "" ;
      H000O2_A19CategoryId = new short[1] ;
      H000O2_A20CategoryName = new String[] {""} ;
      ...
      sCtrlA19CategoryId = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.parks.categorygeneral__default(),
         new Object[] {
             new Object[] {
            H000O2_A19CategoryId, H000O2_A20CategoryName
            }
         }
      );
      AV13Pgmname = "CategoryGeneral" ;
   ...
   private short wcpOA19CategoryId ;
   ...
   private String sCtrlA19CategoryId ;
   ...
   private short[] H000O2_A19CategoryId ;
   private String[] H000O2_A20CategoryName ;
...
final  class categorygeneral__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000O2", "SELECT `CategoryId`, `CategoryName` FROM `Category` WHERE `CategoryId` = ? ORDER BY `CategoryId` ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,true )
      };
   }
