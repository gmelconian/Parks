...
public final  class technicianrepair1wc_impl extends GXWebComponent
{
   public technicianrepair1wc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public technicianrepair1wc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( technicianrepair1wc_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = httpContext.GetFirstPar( "TechnicianAlternateId") ;
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV6TechnicianAlternateId = (short)(GXutil.lval( httpContext.GetPar( "TechnicianAlternateId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6TechnicianAlternateId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6TechnicianAlternateId), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(AV6TechnicianAlternateId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV6TechnicianAlternateId, AV12Update, AV13Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Technician Repair1 WC") ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.parks.technicianrepair1wc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV6TechnicianAlternateId,4,0))}, new String[] {"TechnicianAlternateId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV6TechnicianAlternateId", GXutil.ltrim( localUtil.ntoc( wcpOAV6TechnicianAlternateId, (byte)(4), (byte)(0), ",", "")));
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTECHNICIANALTERNATEID", GXutil.ltrim( localUtil.ntoc( AV6TechnicianAlternateId, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return "TechnicianRepair1WC" ;
   }

   public String getPgmdesc( )
   {
      return "Technician Repair1 WC" ;
   }
   ...
   public void wb1D0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.parks.technicianrepair1wc");
         }
         /* Div Control */
         ...
         ClassString = "BtnAdd" ;
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_TechnicianRepair1WC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.parks.GxWebStd.gx_label_element( httpContext, edtTechnicianAlternateId_Internalname, "Technician Alternate Id", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         com.parks.GxWebStd.gx_single_line_edit( httpContext, edtTechnicianAlternateId_Internalname, GXutil.ltrim( localUtil.ntoc( A35TechnicianAlternateId, (byte)(4), (byte)(0), ",", "")), ((edtTechnicianAlternateId_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A35TechnicianAlternateId), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A35TechnicianAlternateId), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTechnicianAlternateId_Jsonclick, 0, "Attribute", "", "", "", "", edtTechnicianAlternateId_Visible, edtTechnicianAlternateId_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id", "right", false, "", "HLP_TechnicianRepair1WC.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start1D2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Technician Repair1 WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 short AV6TechnicianAlternateId ,
                                 String AV12Update ,
                                 String AV13Delete ,
                                 String sPrefix )
   {
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "TechnicianRepair1WC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf1D2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H001D3 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV6TechnicianAlternateId), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_20_idx = 1 ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_20_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A35TechnicianAlternateId = H001D3_A35TechnicianAlternateId[0] ;
            ...
            A32TechnicianLastName = H001D3_A32TechnicianLastName[0] ;
            A31TechnicianName = H001D3_A31TechnicianName[0] ;
            A30TechnicianId = H001D3_A30TechnicianId[0] ;
            A18GameName = H001D3_A18GameName[0] ;
            A17GameId = H001D3_A17GameId[0] ;
            A27RepairId = H001D3_A27RepairId[0] ;
            A42RepairProblems = H001D3_A42RepairProblems[0] ;
            n42RepairProblems = H001D3_n42RepairProblems[0] ;
            A29RepairDays = H001D3_A29RepairDays[0] ;
            A28RepairBeginDate = H001D3_A28RepairBeginDate[0] ;
            A39RepairDiscountPercentage = H001D3_A39RepairDiscountPercentage[0] ;
            A34RepairCost = H001D3_A34RepairCost[0] ;
            A32TechnicianLastName = H001D3_A32TechnicianLastName[0] ;
            A31TechnicianName = H001D3_A31TechnicianName[0] ;
            A18GameName = H001D3_A18GameName[0] ;
            A42RepairProblems = H001D3_A42RepairProblems[0] ;
   ...
   {
      /* Using cursor H001D5 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV6TechnicianAlternateId)});
      GRID_nRecordCount = H001D5_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void strup1D0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV6TechnicianAlternateId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV6TechnicianAlternateId"), ",", ".")) ;
   ...
   public void e121D2( )
   {
      ...
      AV13Delete = "Eliminar" ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
      edtTechnicianAlternateId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtTechnicianAlternateId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtTechnicianAlternateId_Visible), 5, 0), true);
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "TechnicianAlternateId" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV6TechnicianAlternateId, 4, 0) );
   ...
   {
      AV6TechnicianAlternateId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6TechnicianAlternateId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6TechnicianAlternateId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV6TechnicianAlternateId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "technicianrepair1wc", GetJustCreated( ));
      ...
      {
         AV6TechnicianAlternateId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6TechnicianAlternateId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6TechnicianAlternateId), 4, 0));
      }
      wcpOAV6TechnicianAlternateId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV6TechnicianAlternateId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV6TechnicianAlternateId != wcpOAV6TechnicianAlternateId ) ) )
      {
         setjustcreated();
      }
      wcpOAV6TechnicianAlternateId = AV6TechnicianAlternateId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV6TechnicianAlternateId = httpContext.cgiGet( sPrefix+"AV6TechnicianAlternateId_CTRL") ;
      if ( GXutil.len( sCtrlAV6TechnicianAlternateId) > 0 )
      {
         AV6TechnicianAlternateId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV6TechnicianAlternateId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6TechnicianAlternateId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6TechnicianAlternateId), 4, 0));
      }
      else
      {
         AV6TechnicianAlternateId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV6TechnicianAlternateId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6TechnicianAlternateId_PARM", GXutil.ltrim( localUtil.ntoc( AV6TechnicianAlternateId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV6TechnicianAlternateId)) > 0 )
      {
         com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6TechnicianAlternateId_CTRL", GXutil.rtrim( sCtrlAV6TechnicianAlternateId));
      }
   }
   ...
   public void initialize_properties( )
   {
      ...
      edtTechnicianAlternateId_Visible = 1 ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6TechnicianAlternateId',fld:'vTECHNICIANALTERNATEID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e131D2',iparms:[{av:'A27RepairId',fld:'REPAIRID',pic:'ZZZ9',hsh:true},{av:'A17GameId',fld:'GAMEID',pic:'ZZZ9'}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e111D2',iparms:[{av:'A27RepairId',fld:'REPAIRID',pic:'ZZZ9',hsh:true}]");
      setEventMetadata("'DOINSERT'",",oparms:[]}");
      setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6TechnicianAlternateId',fld:'vTECHNICIANALTERNATEID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
      setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6TechnicianAlternateId',fld:'vTECHNICIANALTERNATEID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
      setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6TechnicianAlternateId',fld:'vTECHNICIANALTERNATEID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
      setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6TechnicianAlternateId',fld:'vTECHNICIANALTERNATEID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H001D3_A35TechnicianAlternateId = new short[1] ;
      H001D3_A32TechnicianLastName = new String[] {""} ;
      H001D3_A31TechnicianName = new String[] {""} ;
      H001D3_A30TechnicianId = new short[1] ;
      H001D3_A18GameName = new String[] {""} ;
      H001D3_A17GameId = new short[1] ;
      H001D3_A27RepairId = new short[1] ;
      H001D3_A42RepairProblems = new byte[1] ;
      H001D3_n42RepairProblems = new boolean[] {false} ;
      H001D3_A29RepairDays = new short[1] ;
      H001D3_A28RepairBeginDate = new java.util.Date[] {GXutil.nullDate()} ;
      H001D3_A39RepairDiscountPercentage = new short[1] ;
      H001D3_A34RepairCost = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H001D5_AGRID_nRecordCount = new long[1] ;
      ...
      sCtrlAV6TechnicianAlternateId = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.parks.technicianrepair1wc__default(),
         new Object[] {
             new Object[] {
            H001D3_A35TechnicianAlternateId, H001D3_A32TechnicianLastName, H001D3_A31TechnicianName, H001D3_A30TechnicianId, H001D3_A18GameName, H001D3_A17GameId, H001D3_A27RepairId, H001D3_A42RepairProblems, H001D3_n42RepairProblems, H001D3_A29RepairDays,
            H001D3_A28RepairBeginDate, H001D3_A39RepairDiscountPercentage, H001D3_A34RepairCost
            }
            , new Object[] {
            H001D5_AGRID_nRecordCount
            }
         }
      );
      AV17Pgmname = "TechnicianRepair1WC" ;
   ...
   private short wcpOAV6TechnicianAlternateId ;
   private short AV6TechnicianAlternateId ;
   private short wbEnd ;
   ...
   private int edtTechnicianAlternateId_Visible ;
   ...
   private String sCtrlAV6TechnicianAlternateId ;
   ...
   private short[] H001D3_A35TechnicianAlternateId ;
   private String[] H001D3_A32TechnicianLastName ;
   private String[] H001D3_A31TechnicianName ;
   private short[] H001D3_A30TechnicianId ;
   private String[] H001D3_A18GameName ;
   private short[] H001D3_A17GameId ;
   private short[] H001D3_A27RepairId ;
   private byte[] H001D3_A42RepairProblems ;
   private boolean[] H001D3_n42RepairProblems ;
   private short[] H001D3_A29RepairDays ;
   private java.util.Date[] H001D3_A28RepairBeginDate ;
   private short[] H001D3_A39RepairDiscountPercentage ;
   private java.math.BigDecimal[] H001D3_A34RepairCost ;
   private long[] H001D5_AGRID_nRecordCount ;
...
final  class technicianrepair1wc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001D3", "SELECT T1.`TechnicianAlternateId`, T2.`TechnicianLastName`, T2.`TechnicianName`, T1.`TechnicianId`, T3.`GameName`, T1.`GameId`, T1.`RepairId`, COALESCE( T4.`RepairProblems`, 0) AS RepairProblems, T1.`RepairDays`, T1.`RepairBeginDate`, T1.`RepairDiscountPercentage`, T1.`RepairCost` FROM (((`Repair` T1 INNER JOIN `Technician` T2 ON T2.`TechnicianId` = T1.`TechnicianId`) INNER JOIN `Game` T3 ON T3.`GameId` = T1.`GameId`) LEFT JOIN (SELECT COUNT(*) AS RepairProblems, `RepairId` FROM `RepairKind` GROUP BY `RepairId` ) T4 ON T4.`RepairId` = T1.`RepairId`) WHERE T1.`TechnicianAlternateId` = ? ORDER BY T1.`TechnicianAlternateId`  LIMIT ?, ?",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H001D5", "SELECT COUNT(*) FROM (((`Repair` T1 INNER JOIN `Technician` T3 ON T3.`TechnicianId` = T1.`TechnicianId`) INNER JOIN `Game` T2 ON T2.`GameId` = T1.`GameId`) LEFT JOIN (SELECT COUNT(*) AS RepairProblems, `RepairId` FROM `RepairKind` GROUP BY `RepairId` ) T4 ON T4.`RepairId` = T1.`RepairId`) WHERE T1.`TechnicianAlternateId` = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
