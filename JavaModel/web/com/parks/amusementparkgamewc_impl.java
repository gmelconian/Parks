...
public final  class amusementparkgamewc_impl extends GXWebComponent
{
   public amusementparkgamewc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public amusementparkgamewc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( amusementparkgamewc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Amusement Park Game WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2021102014431849", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   public void wb0L0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.parks.amusementparkgamewc");
         }
         /* Div Control */
         ...
         ClassString = "BtnAdd" ;
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_AmusementParkGameWC.htm");
   ...
   public void start0L2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Amusement Park Game WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop(sPrefix, false, edtGamePhoto_Internalname, "Bitmap", ((GXutil.strcmp("", A21GamePhoto)==0) ? A40000GamePhoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A21GamePhoto))), !bGXsfl_20_Refreshing);
                           httpContext.ajax_rsp_assign_prop(sPrefix, false, edtGamePhoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A21GamePhoto), true);
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_GAMEID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A17GameId), "ZZZ9")));
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"GAMEID", GXutil.ltrim( localUtil.ntoc( A17GameId, (byte)(4), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "AmusementParkGameWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf0L2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            ...
            A21GamePhoto = H000L2_A21GamePhoto[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtGamePhoto_Internalname, "Bitmap", ((GXutil.strcmp("", A21GamePhoto)==0) ? A40000GamePhoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A21GamePhoto))), !bGXsfl_20_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtGamePhoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A21GamePhoto), true);
            A40000GamePhoto_GXI = H000L2_A40000GamePhoto_GXI[0] ;
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtGamePhoto_Internalname, "Bitmap", ((GXutil.strcmp("", A21GamePhoto)==0) ? A40000GamePhoto_GXI : httpContext.convertURL( httpContext.getResourceRelative(A21GamePhoto))), !bGXsfl_20_Refreshing);
            httpContext.ajax_rsp_assign_prop(sPrefix, false, edtGamePhoto_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( A21GamePhoto), true);
            A20CategoryName = H000L2_A20CategoryName[0] ;
            A19CategoryId = H000L2_A19CategoryId[0] ;
            n19CategoryId = H000L2_n19CategoryId[0] ;
            A18GameName = H000L2_A18GameName[0] ;
            A17GameId = H000L2_A17GameId[0] ;
            A20CategoryName = H000L2_A20CategoryName[0] ;
            e130L2 ();
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_GAMEID"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( DecimalUtil.doubleToDec(A17GameId), "ZZZ9")));
   }
   ...
   public void S112( )
   {
      ...
      AV10TrnContext.setgxTv_SdtTransactionContext_Transactionname( "Game" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "amusementparkgamewc", GetJustCreated( ));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2021102014431894", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("amusementparkgamewc.js", "?2021102014431895", false, true);
      }
   ...
   public void subsflControlProps_202( )
   {
      ...
      edtGamePhoto_Internalname = sPrefix+"GAMEPHOTO_"+sGXsfl_20_idx ;
   ...
   public void subsflControlProps_fel_202( )
   {
      ...
      edtGamePhoto_Internalname = sPrefix+"GAMEPHOTO_"+sGXsfl_20_fel_idx ;
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCategoryId_Internalname,GXutil.ltrim( localUtil.ntoc( A19CategoryId, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A19CategoryId), "ZZZ9"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtCategoryId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"number","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(20),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCategoryName_Internalname,GXutil.rtrim( A20CategoryName),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtCategoryName_Link,"","","",edtCategoryName_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(50),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(20),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"Name","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
   ...
   public void init_default_properties( )
   {
      ...
      edtGamePhoto_Internalname = sPrefix+"GAMEPHOTO" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e130L2',iparms:[{av:'A17GameId',fld:'GAMEID',pic:'ZZZ9',hsh:true},{av:'A19CategoryId',fld:'CATEGORYID',pic:'ZZZ9'}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtGameName_Link',ctrl:'GAMENAME',prop:'Link'},{av:'edtCategoryName_Link',ctrl:'CATEGORYNAME',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e110L2',iparms:[{av:'A17GameId',fld:'GAMEID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      H000L2_A21GamePhoto = new String[] {""} ;
      H000L2_A40000GamePhoto_GXI = new String[] {""} ;
      H000L2_A20CategoryName = new String[] {""} ;
      H000L2_A19CategoryId = new short[1] ;
      H000L2_n19CategoryId = new boolean[] {false} ;
      H000L2_A18GameName = new String[] {""} ;
      H000L2_A17GameId = new short[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.parks.amusementparkgamewc__default(),
         new Object[] {
             new Object[] {
            H000L2_A7AmusementParkId, H000L2_A21GamePhoto, H000L2_A40000GamePhoto_GXI, H000L2_A20CategoryName, H000L2_A19CategoryId, H000L2_n19CategoryId, H000L2_A18GameName, H000L2_A17GameId
            }
            , new Object[] {
   ...
   private String[] H000L2_A21GamePhoto ;
   private String[] H000L2_A40000GamePhoto_GXI ;
   private String[] H000L2_A20CategoryName ;
   private short[] H000L2_A19CategoryId ;
   private boolean[] H000L2_n19CategoryId ;
   private String[] H000L2_A18GameName ;
   private short[] H000L2_A17GameId ;
...
final  class amusementparkgamewc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000L2", "SELECT T1.`AmusementParkId`, T1.`GamePhoto`, T1.`GamePhoto_GXI`, T2.`CategoryName`, T1.`CategoryId`, T1.`GameName`, T1.`GameId` FROM (`Game` T1 LEFT JOIN `Category` T2 ON T2.`CategoryId` = T1.`CategoryId`) WHERE T1.`AmusementParkId` = ? ORDER BY T1.`AmusementParkId`  LIMIT ?, ?",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H000L3", "SELECT COUNT(*) FROM (`Game` T1 LEFT JOIN `Category` T2 ON T2.`CategoryId` = T1.`CategoryId`) WHERE T1.`AmusementParkId` = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
