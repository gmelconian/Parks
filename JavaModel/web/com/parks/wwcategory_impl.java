...
public final  class wwcategory_impl extends GXDataArea
{
   public wwcategory_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwcategory_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwcategory_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            AV11CategoryName = httpContext.GetPar( "CategoryName") ;
            AV12Update = httpContext.GetPar( "Update") ;
            AV13Delete = httpContext.GetPar( "Delete") ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2021102014432268", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.parks.wwcategory", new String[] {}, new String[] {}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.parks.GxWebStd.gx_hidden_field( httpContext, "GXH_vCATEGORYNAME", GXutil.rtrim( AV11CategoryName));
      /* Send saved values. */
   ...
   {
      return formatLink("com.parks.wwcategory", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb0N0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.parks.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Categories", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, (short)(0), "HLP_WWCategory.htm");
         ...
         ClassString = "BtnAdd" ;
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 25, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWCategory.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.parks.GxWebStd.gx_label_element( httpContext, edtavCategoryname_Internalname, "Category Name", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"" ;
         com.parks.GxWebStd.gx_single_line_edit( httpContext, edtavCategoryname_Internalname, GXutil.rtrim( AV11CategoryName), GXutil.rtrim( localUtil.format( AV11CategoryName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavCategoryname_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavCategoryname_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_WWCategory.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start0N2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Categories", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 if ( ! wbErr )
                                 {
                                    ...
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vCATEGORYNAME"), AV11CategoryName) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void rf0N2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV11CategoryName = GXutil.padr( GXutil.rtrim( AV11CategoryName), 50, "%") ;
         /* Using cursor H000N2 */
         pr_default.execute(0, new Object[] {lV11CategoryName, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_25_idx = 1 ;
         sGXsfl_25_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_25_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_252( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A20CategoryName = H000N2_A20CategoryName[0] ;
            A19CategoryId = H000N2_A19CategoryId[0] ;
            e140N2 ();
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, "gxhash_CATEGORYID"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, localUtil.format( DecimalUtil.doubleToDec(A19CategoryId), "ZZZ9")));
   }
   ...
   public void subgrid_varsfromstate( )
   {
      if ( GridState.getFiltercount() >= 1 )
      {
         ...
         httpContext.ajax_rsp_assign_attri("", false, "AV11CategoryName", AV11CategoryName);
      }
   ...
   public void strup0N0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV11CategoryName = httpContext.cgiGet( edtavCategoryname_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV11CategoryName", AV11CategoryName);
   ...
   private void e140N2( )
   {
      /* Grid_Load Routine */
      returnInSub = false ;
      edtavUpdate_Link = formatLink("com.parks.category", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.ltrimstr(A19CategoryId,4,0))}, new String[] {"Mode","CategoryId"})  ;
      edtavDelete_Link = formatLink("com.parks.category", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.ltrimstr(A19CategoryId,4,0))}, new String[] {"Mode","CategoryId"})  ;
   ...
   public void e110N2( )
   {
      /* 'DoInsert' Routine */
      returnInSub = false ;
      callWebObject(formatLink("com.parks.category", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.ltrimstr(0,9,0))}, new String[] {"Mode","CategoryId"}) );
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S112( )
   {
      ...
      AV9TrnContext.setgxTv_SdtTransactionContext_Transactionname( "Category" );
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202110201443233", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("wwcategory.js", "?202110201443233", false, true);
      }
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e140N2',iparms:[{av:'A19CategoryId',fld:'CATEGORYID',pic:'ZZZ9',hsh:true}]");
      ...
      setEventMetadata("'DOINSERT'","{handler:'e110N2',iparms:[{av:'A19CategoryId',fld:'CATEGORYID',pic:'ZZZ9',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV11CategoryName = "" ;
      H000N2_A20CategoryName = new String[] {""} ;
      H000N2_A19CategoryId = new short[1] ;
      ...
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.parks.wwcategory__default(),
         new Object[] {
             new Object[] {
            H000N2_A20CategoryName, H000N2_A19CategoryId
            }
            , new Object[] {
   ...
   private String[] H000N2_A20CategoryName ;
   private short[] H000N2_A19CategoryId ;
...
final  class wwcategory__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          String A20CategoryName )
   {
      ...
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV11CategoryName)==0) )
      {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000N2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
            case 1 :
                  return conditional_H000N3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
      }
