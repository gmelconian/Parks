...
public final  class amusementparkemployeewc_impl extends GXWebComponent
{
   public amusementparkemployeewc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public amusementparkemployeewc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( amusementparkemployeewc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV6AmusementParkId = (short)(GXutil.lval( httpContext.GetPar( "AmusementParkId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6AmusementParkId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6AmusementParkId), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(AV6AmusementParkId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxNewRow_"+"Grid") == 0 )
            {
               ...
               AV13Update = httpContext.GetPar( "Update") ;
               AV14Delete = httpContext.GetPar( "Delete") ;
               httpContext.setAjaxCallMode();
               if ( ! httpContext.IsValidAjaxCall( true) )
               {
                  GxWebError = (byte)(1) ;
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV6AmusementParkId, AV13Update, AV14Delete, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Amusement Park Employee WC") ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.parks.amusementparkemployeewc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV6AmusementParkId,4,0))}, new String[] {"AmusementParkId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV6AmusementParkId", GXutil.ltrim( localUtil.ntoc( wcpOAV6AmusementParkId, (byte)(4), (byte)(0), ",", "")));
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vAMUSEMENTPARKID", GXutil.ltrim( localUtil.ntoc( AV6AmusementParkId, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return "AmusementParkEmployeeWC" ;
   }
   ...
   public void wb0K0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.parks.amusementparkemployeewc");
         }
         /* Div Control */
         ...
         ClassString = "BtnAdd" ;
         StyleString = "" ;
         com.parks.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_AmusementParkEmployeeWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.parks.GxWebStd.gx_label_element( httpContext, edtAmusementParkId_Internalname, "Amusement Park Id", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         com.parks.GxWebStd.gx_single_line_edit( httpContext, edtAmusementParkId_Internalname, GXutil.ltrim( localUtil.ntoc( A7AmusementParkId, (byte)(4), (byte)(0), ",", "")), ((edtAmusementParkId_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A7AmusementParkId), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A7AmusementParkId), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAmusementParkId_Jsonclick, 0, "Attribute", "", "", "", "", edtAmusementParkId_Visible, edtAmusementParkId_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id", "right", false, "", "HLP_AmusementParkEmployeeWC.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start0K2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Amusement Park Employee WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavUpdate_Internalname, AV13Update);
                           AV14Delete = httpContext.cgiGet( edtavDelete_Internalname) ;
                           httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDelete_Internalname, AV14Delete);
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_EMPLOYEEID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A1EmployeeId), "ZZZ9")));
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"EMPLOYEEID", GXutil.ltrim( localUtil.ntoc( A1EmployeeId, (byte)(4), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "AmusementParkEmployeeWC" ;
      Gx_err = (short)(0) ;
   ...
   public void rf0K2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H000K2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV6AmusementParkId), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_20_idx = 1 ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_20_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A7AmusementParkId = H000K2_A7AmusementParkId[0] ;
            n7AmusementParkId = H000K2_n7AmusementParkId[0] ;
            ...
            A6EmployeeEmail = H000K2_A6EmployeeEmail[0] ;
            A5EmployeePhone = H000K2_A5EmployeePhone[0] ;
            A4EmployeeAddress = H000K2_A4EmployeeAddress[0] ;
            A3EmployeeLastName = H000K2_A3EmployeeLastName[0] ;
            A2EmployeeName = H000K2_A2EmployeeName[0] ;
            A26EmployeeAddedDate = H000K2_A26EmployeeAddedDate[0] ;
            A1EmployeeId = H000K2_A1EmployeeId[0] ;
            e130K2 ();
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_EMPLOYEEID"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( DecimalUtil.doubleToDec(A1EmployeeId), "ZZZ9")));
   }
   ...
   {
      /* Using cursor H000K3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV6AmusementParkId)});
   ...
   public void strup0K0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV6AmusementParkId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV6AmusementParkId"), ",", ".")) ;
   ...
   public void e120K2( )
   {
      ...
      AV14Delete = "Eliminar" ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, edtavDelete_Internalname, AV14Delete);
      edtAmusementParkId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtAmusementParkId_Internalname, "Visible", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtAmusementParkId_Visible), 5, 0), true);
   ...
   public void S112( )
   {
      ...
      AV10TrnContext.setgxTv_SdtTransactionContext_Transactionname( "Employee" );
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "AmusementParkId" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV6AmusementParkId, 4, 0) );
   ...
   {
      AV6AmusementParkId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6AmusementParkId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6AmusementParkId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV6AmusementParkId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "amusementparkemployeewc", GetJustCreated( ));
      ...
      {
         AV6AmusementParkId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6AmusementParkId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6AmusementParkId), 4, 0));
      }
      wcpOAV6AmusementParkId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV6AmusementParkId"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV6AmusementParkId != wcpOAV6AmusementParkId ) ) )
      {
         setjustcreated();
      }
      wcpOAV6AmusementParkId = AV6AmusementParkId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV6AmusementParkId = httpContext.cgiGet( sPrefix+"AV6AmusementParkId_CTRL") ;
      if ( GXutil.len( sCtrlAV6AmusementParkId) > 0 )
      {
         AV6AmusementParkId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV6AmusementParkId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6AmusementParkId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6AmusementParkId), 4, 0));
      }
      else
      {
         AV6AmusementParkId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV6AmusementParkId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6AmusementParkId_PARM", GXutil.ltrim( localUtil.ntoc( AV6AmusementParkId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV6AmusementParkId)) > 0 )
      {
         com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6AmusementParkId_CTRL", GXutil.rtrim( sCtrlAV6AmusementParkId));
      }
   }
   ...
   {
      edtEmployeeId_Internalname = sPrefix+"EMPLOYEEID_"+sGXsfl_20_idx ;
      edtEmployeeAddedDate_Internalname = sPrefix+"EMPLOYEEADDEDDATE_"+sGXsfl_20_idx ;
      edtEmployeeName_Internalname = sPrefix+"EMPLOYEENAME_"+sGXsfl_20_idx ;
      edtEmployeeLastName_Internalname = sPrefix+"EMPLOYEELASTNAME_"+sGXsfl_20_idx ;
      edtEmployeeAddress_Internalname = sPrefix+"EMPLOYEEADDRESS_"+sGXsfl_20_idx ;
      edtEmployeePhone_Internalname = sPrefix+"EMPLOYEEPHONE_"+sGXsfl_20_idx ;
      edtEmployeeEmail_Internalname = sPrefix+"EMPLOYEEEMAIL_"+sGXsfl_20_idx ;
   ...
   {
      edtEmployeeId_Internalname = sPrefix+"EMPLOYEEID_"+sGXsfl_20_fel_idx ;
      edtEmployeeAddedDate_Internalname = sPrefix+"EMPLOYEEADDEDDATE_"+sGXsfl_20_fel_idx ;
      edtEmployeeName_Internalname = sPrefix+"EMPLOYEENAME_"+sGXsfl_20_fel_idx ;
      edtEmployeeLastName_Internalname = sPrefix+"EMPLOYEELASTNAME_"+sGXsfl_20_fel_idx ;
      edtEmployeeAddress_Internalname = sPrefix+"EMPLOYEEADDRESS_"+sGXsfl_20_fel_idx ;
      edtEmployeePhone_Internalname = sPrefix+"EMPLOYEEPHONE_"+sGXsfl_20_fel_idx ;
      edtEmployeeEmail_Internalname = sPrefix+"EMPLOYEEEMAIL_"+sGXsfl_20_fel_idx ;
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtEmployeeId_Internalname,GXutil.ltrim( localUtil.ntoc( A1EmployeeId, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A1EmployeeId), "ZZZ9"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtEmployeeId_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"number","1",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(4),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(20),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"Id","right",Boolean.valueOf(false),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtEmployeeLastName_Internalname,GXutil.rtrim( A3EmployeeLastName),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtEmployeeLastName_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(20),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"LastName","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtEmployeeAddress_Internalname,A4EmployeeAddress,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","http://maps.google.com/maps?q="+PrivateUtilities.encodeURL( A4EmployeeAddress),"_blank","","",edtEmployeeAddress_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(1024),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(20),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"GeneXus\\Address","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtEmployeePhone_Internalname,GXutil.rtrim( A5EmployeePhone),"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",gxphoneLink,"","","",edtEmployeePhone_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"tel","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(20),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(20),Integer.valueOf(1),Integer.valueOf(-1),Integer.valueOf(0),Boolean.valueOf(true),"GeneXus\\Phone","left",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6AmusementParkId',fld:'vAMUSEMENTPARKID',pic:'ZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      setEventMetadata("REFRESH",",oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e130K2',iparms:[{av:'A1EmployeeId',fld:'EMPLOYEEID',pic:'ZZZ9',hsh:true}]");
      setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtEmployeeName_Link',ctrl:'EMPLOYEENAME',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e110K2',iparms:[{av:'A1EmployeeId',fld:'EMPLOYEEID',pic:'ZZZ9',hsh:true}]");
      setEventMetadata("'DOINSERT'",",oparms:[]}");
      setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6AmusementParkId',fld:'vAMUSEMENTPARKID',pic:'ZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
      setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6AmusementParkId',fld:'vAMUSEMENTPARKID',pic:'ZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
      setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6AmusementParkId',fld:'vAMUSEMENTPARKID',pic:'ZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
      setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6AmusementParkId',fld:'vAMUSEMENTPARKID',pic:'ZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H000K2_A7AmusementParkId = new short[1] ;
      H000K2_n7AmusementParkId = new boolean[] {false} ;
      H000K2_A6EmployeeEmail = new String[] {""} ;
      H000K2_A5EmployeePhone = new String[] {""} ;
      H000K2_A4EmployeeAddress = new String[] {""} ;
      H000K2_A3EmployeeLastName = new String[] {""} ;
      H000K2_A2EmployeeName = new String[] {""} ;
      H000K2_A26EmployeeAddedDate = new java.util.Date[] {GXutil.nullDate()} ;
      H000K2_A1EmployeeId = new short[1] ;
      ...
      sCtrlAV6AmusementParkId = "" ;
      ROClassString = "" ;
      gxphoneLink = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.parks.amusementparkemployeewc__default(),
         new Object[] {
             new Object[] {
            H000K2_A7AmusementParkId, H000K2_n7AmusementParkId, H000K2_A6EmployeeEmail, H000K2_A5EmployeePhone, H000K2_A4EmployeeAddress, H000K2_A3EmployeeLastName, H000K2_A2EmployeeName, H000K2_A26EmployeeAddedDate, H000K2_A1EmployeeId
            }
            , new Object[] {
   ...
   private short wcpOAV6AmusementParkId ;
   ...
   private int edtAmusementParkId_Visible ;
   ...
   private String sCtrlAV6AmusementParkId ;
   ...
   private short[] H000K2_A7AmusementParkId ;
   private boolean[] H000K2_n7AmusementParkId ;
   private String[] H000K2_A6EmployeeEmail ;
   private String[] H000K2_A5EmployeePhone ;
   private String[] H000K2_A4EmployeeAddress ;
   private String[] H000K2_A3EmployeeLastName ;
   private String[] H000K2_A2EmployeeName ;
   private java.util.Date[] H000K2_A26EmployeeAddedDate ;
   private short[] H000K2_A1EmployeeId ;
...
final  class amusementparkemployeewc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000K2", "SELECT `AmusementParkId`, `EmployeeEmail`, `EmployeePhone`, `EmployeeAddress`, `EmployeeLastName`, `EmployeeName`, `EmployeeAddedDate`, `EmployeeId` FROM `Employee` WHERE `AmusementParkId` = ? ORDER BY `AmusementParkId`  LIMIT ?, ?",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H000K3", "SELECT COUNT(*) FROM `Employee` WHERE `AmusementParkId` = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
