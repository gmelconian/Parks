...
public final  class countrycitywc_impl extends GXWebComponent
{
   public countrycitywc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public countrycitywc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( countrycitywc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV6CountryId = (short)(GXutil.lval( httpContext.GetPar( "CountryId"))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6CountryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6CountryId), 4, 0));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,Short.valueOf(AV6CountryId)});
               componentstart();
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "Country City WC") ;
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.parks.countrycitywc", new String[] {GXutil.URLEncode(GXutil.ltrimstr(AV6CountryId,4,0))}, new String[] {"CountryId"}) +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV6CountryId", GXutil.ltrim( localUtil.ntoc( wcpOAV6CountryId, (byte)(4), (byte)(0), ",", "")));
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vCOUNTRYID", GXutil.ltrim( localUtil.ntoc( AV6CountryId, (byte)(4), (byte)(0), ",", "")));
   ...
   public void wb0T0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.parks.countrycitywc");
         }
         /* Div Control */
      ...
      if ( wbEnd == 12 )
      {
         ...
         com.parks.GxWebStd.gx_label_element( httpContext, edtCountryId_Internalname, "Country Id", "col-sm-3 AttributeLabel", 0, true, "");
         /* Single line edit */
         com.parks.GxWebStd.gx_single_line_edit( httpContext, edtCountryId_Internalname, GXutil.ltrim( localUtil.ntoc( A12CountryId, (byte)(4), (byte)(0), ",", "")), ((edtCountryId_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A12CountryId), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A12CountryId), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCountryId_Jsonclick, 0, "Attribute", "", "", "", "", edtCountryId_Visible, edtCountryId_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Id", "right", false, "", "HLP_CountryCityWC.htm");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.parks.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start0T2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "Country City WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void rf0T2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H000T2 */
         pr_default.execute(0, new Object[] {Short.valueOf(AV6CountryId), Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_12_idx = 1 ;
         sGXsfl_12_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_12_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_122( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            ...
            A25CityName = H000T2_A25CityName[0] ;
            A24CityId = H000T2_A24CityId[0] ;
            e120T2 ();
   ...
   {
      /* Using cursor H000T3 */
      pr_default.execute(1, new Object[] {Short.valueOf(AV6CountryId)});
   ...
   public void strup0T0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV6CountryId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV6CountryId"), ",", ".")) ;
   ...
   public void S112( )
   {
      ...
      AV10TrnContext.setgxTv_SdtTransactionContext_Transactionname( "Country" );
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "CountryId" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV6CountryId, 4, 0) );
   ...
   {
      AV6CountryId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6CountryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6CountryId), 4, 0));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV6CountryId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "countrycitywc", GetJustCreated( ));
      ...
      {
         AV6CountryId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6CountryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6CountryId), 4, 0));
      }
      wcpOAV6CountryId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV6CountryId"), ",", ".")) ;
   ...
   public void wcparametersget( )
   {
      ...
      sCtrlAV6CountryId = httpContext.cgiGet( sPrefix+"AV6CountryId_CTRL") ;
      if ( GXutil.len( sCtrlAV6CountryId) > 0 )
      {
         AV6CountryId = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV6CountryId), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV6CountryId", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV6CountryId), 4, 0));
      }
      else
      {
         AV6CountryId = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV6CountryId_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6CountryId_PARM", GXutil.ltrim( localUtil.ntoc( AV6CountryId, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV6CountryId)) > 0 )
      {
         com.parks.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6CountryId_CTRL", GXutil.rtrim( sCtrlAV6CountryId));
      }
   }
   ...
   {
      edtCityId_Internalname = sPrefix+"CITYID_"+sGXsfl_12_idx ;
      edtCityName_Internalname = sPrefix+"CITYNAME_"+sGXsfl_12_idx ;
   }

   public void subsflControlProps_fel_122( )
   {
      edtCityId_Internalname = sPrefix+"CITYID_"+sGXsfl_12_fel_idx ;
      edtCityName_Internalname = sPrefix+"CITYNAME_"+sGXsfl_12_fel_idx ;
   }
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e120T2',iparms:[]");
   ...
   public void initialize( )
   {
      ...
      H000T2_A25CityName = new String[] {""} ;
      H000T2_A24CityId = new short[1] ;
      ...
      sCtrlAV6CountryId = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.parks.countrycitywc__default(),
         new Object[] {
             new Object[] {
            H000T2_A12CountryId, H000T2_A25CityName, H000T2_A24CityId
            }
            , new Object[] {
   ...
   private String[] H000T2_A25CityName ;
   private short[] H000T2_A24CityId ;
...
final  class countrycitywc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000T2", "SELECT `CountryId`, `CityName`, `CityId` FROM `CountryCity` WHERE `CountryId` = ? ORDER BY `CountryId`  LIMIT ?, ?",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11, GxCacheFrequency.OFF,false )
         ,new ForEachCursor("H000T3", "SELECT COUNT(*) FROM `CountryCity` WHERE `CountryId` = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1, GxCacheFrequency.OFF,false )
      };
   }
